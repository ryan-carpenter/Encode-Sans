...
<details>
<summary><b>[118] EncodeSansSemiCondensedSC-Black.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiCondensed SC Black" while METADATA.pb has "Encode Sans SemiCondensed SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiCond SC Black" while METADATA.pb has "Encode Sans SemiCondensed SC Black". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiCondensed SC Black" does not match post_script_name = "EncodeSansSemiCondSC-Black"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiCondensedSC-Black.ttf" does not match post_script_name="EncodeSansSemiCondSC-Black".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCondSC-Black") does not match correct font name format ("Encode Sans SemiCondensed SC Black").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed SC Black") does not match name table entry "Encode Sans SemiCond SC Black" ! [code: fullname-mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1198 but it should be 1228 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [loca, fpgm, prep, GPOS, DSIG, GSUB, cvt , gasp]
...
* :bread: **PASS** Postscript name "EncodeSansSemiCondSC-Black" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiCondensed SC' in 'Encode Sans SemiCondensed SC Black')
