...
|  | fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-ExtraBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, GPOS, DSIG, fpgm, loca, prep, cvt , gasp]
...
* :bread: **PASS** fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-ExtraBold.ttf is named canonically.
