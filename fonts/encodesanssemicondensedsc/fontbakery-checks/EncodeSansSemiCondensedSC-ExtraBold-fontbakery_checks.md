...
<details>
<summary><b>[118] EncodeSansSemiCondensedSC-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiCondensed SC ExtraBold" while METADATA.pb has "Encode Sans SemiCondensed SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansSemiCondSC-XBold" while METADATA.pb has "EncodeSansSemiCondSC-ExBold". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiCond SC XBold" while METADATA.pb has "Encode Sans SemiCondensed SC ExtraBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiCondensed SC ExtraBold" does not match post_script_name = "EncodeSansSemiCondSC-ExBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiCondensedSC-ExtraBold.ttf" does not match post_script_name="EncodeSansSemiCondSC-ExBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCondSC-ExBold") does not match correct font name format ("Encode Sans SemiCondensed SC ExtraBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed SC ExtraBold") does not match name table entry "Encode Sans SemiCond SC XBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiCondSC-ExBold") and weight value (800). The name must be ended with "ExtraBold" or "ExtraBoldItalic".
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1164 but it should be 1194 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [gasp, cvt , DSIG, loca, fpgm, prep, GPOS, GSUB]
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiCondensed SC' in 'Encode Sans SemiCondensed SC ExtraBold')
