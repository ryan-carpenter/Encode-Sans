...
<details>
<summary><b>[118] EncodeSansSemiCondensedSC-Bold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiCond SC Bold" while METADATA.pb has "Encode Sans SemiCondensed SC Bold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiCondensed SC Bold" does not match post_script_name = "EncodeSansSemiCondSC-Bold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiCondensedSC-Bold.ttf" does not match post_script_name="EncodeSansSemiCondSC-Bold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCondSC-Bold") does not match correct font name format ("Encode Sans SemiCondensed SC").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed SC Bold") does not match name table entry "Encode Sans SemiCond SC Bold" ! [code: fullname-mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1132 but it should be 1162 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [prep, DSIG, loca, GPOS, gasp, GSUB, fpgm, cvt ]
...
* :bread: **PASS** Postscript name "EncodeSansSemiCondSC-Bold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiCondensed SC' in 'Encode Sans SemiCondensed SC Bold')
