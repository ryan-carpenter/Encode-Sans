...
<details>
<summary><b>[118] EncodeSansSemiCondensedSC-SemiBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiCondensed SC SemiBold" while METADATA.pb has "Encode Sans SemiCondensed SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiCond SC SemiBold" while METADATA.pb has "Encode Sans SemiCondensed SC SemiBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiCondensed SC SemiBold" does not match post_script_name = "EncodeSansSemiCondSC-SemiBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiCondensedSC-SemiBold.ttf" does not match post_script_name="EncodeSansSemiCondSC-SemiBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCondSC-SemiBold") does not match correct font name format ("Encode Sans SemiCondensed SC SemiBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed SC SemiBold") does not match name table entry "Encode Sans SemiCond SC SemiBold" ! [code: fullname-mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1103 but it should be 1132 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, fpgm, prep, cvt , gasp, DSIG, GSUB, loca]
...
* :bread: **PASS** Postscript name "EncodeSansSemiCondSC-SemiBold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiCondensed SC' in 'Encode Sans SemiCondensed SC SemiBold')
