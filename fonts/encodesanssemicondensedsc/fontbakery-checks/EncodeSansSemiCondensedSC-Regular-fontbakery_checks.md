...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiCondensed SC Regular" does not match post_script_name = "EncodeSansSemiCondSC-Reg"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiCondensedSC-Regular.ttf" does not match post_script_name="EncodeSansSemiCondSC-Reg".
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiCondSC-Reg") and weight value (400). The name must be ended with "Regular" or "Italic".
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1049 but it should be 1078 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [cvt , prep, gasp, loca, fpgm, DSIG, GSUB, GPOS]
