...
<details>
<summary><b>[118] EncodeSansSemiCondensedSC-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiCondensed SC Light" while METADATA.pb has "Encode Sans SemiCondensed SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiCond SC Lght" while METADATA.pb has "Encode Sans SemiCondensed SC Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiCondensed SC Light" does not match post_script_name = "EncodeSansSemiCondSC-Lght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiCondensedSC-Light.ttf" does not match post_script_name="EncodeSansSemiCondSC-Lght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCondSC-Lght") does not match correct font name format ("Encode Sans SemiCondensed SC Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed SC Light") does not match name table entry "Encode Sans SemiCond SC Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiCondSC-Lght") and weight value (300). The name must be ended with "Light" or "LightItalic".
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1028 but it should be 1056 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, DSIG, cvt , fpgm, prep, GPOS, loca, gasp]
...
* :bread: **PASS** Postscript name "EncodeSansSemiCondSC-Lght" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiCondensed SC' in 'Encode Sans SemiCondensed SC Light')
