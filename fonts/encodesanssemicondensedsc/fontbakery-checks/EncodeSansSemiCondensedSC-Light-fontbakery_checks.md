...
|  | fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-Light.ttf |
|:--- | ---:|
| Dehinted Size | 80.2kb |
| Hinted Size | 110.6kb |
| Increase | 30.4kb |
| Change   | 37.9 % |
...
* :information_source: **INFO** This font contains the following optional tables [cvt , DSIG, prep, GPOS, fpgm, gasp, loca, GSUB]
...
* :bread: **PASS** fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-Light.ttf is named canonically.
