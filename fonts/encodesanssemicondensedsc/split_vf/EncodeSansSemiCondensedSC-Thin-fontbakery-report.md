...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiCondensed Light SC" while METADATA.pb has "Encode Sans SemiCondensed SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansSemiCondSC-Lght" while METADATA.pb has "EncodeSansSemiCondSC-Thin". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiCond Lght SC Reg" while METADATA.pb has "Encode Sans SemiCondensed SC Thin". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCondSC-Thin") does not match correct font name format ("Encode Sans SemiCondensed Light SC").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed SC Thin") does not match name table entry "Encode Sans SemiCond Lght SC Reg" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed SC Thin' but got 'Encode Sans SemiCondensed Light SC'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed SC Thin' but got 'Encode Sans SemiCond Lght SC Reg'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiCondensedSC-Thin' but got 'EncodeSansSemiCondSC-Lght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiCondensed Light SC') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiCond Lght SC Reg') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans SemiCondensed Light SC' / SUBFAMILY_NAME = 'Regular'
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans SemiCondensed Light SC | exceeds max length (31) |
