...
<details>
<summary><b>[116] EncodeSansSemiCondensedSC-Thin.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Condensed SC" while METADATA.pb has "Encode Sans SemiCondensed SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Cond SC Thin" while METADATA.pb has "Encode Sans SemiCondensed SC Thin". [code: mismatch]
...
* :fire: **FAIL** Unmatched familyname in font: TTF has "Encode Sans Semi Condensed SC" while METADATA.pb has name="Encode Sans SemiCondensed SC". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.name field ("Encode Sans SemiCondensed SC") does not match correct font name format ("Encode Sans Semi Condensed SC").
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiCondensed SC Thin") does not match correct font name format ("Encode Sans Semi Condensed SC").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCondSC-Thin") does not match correct font name format ("Encode Sans Semi Condensed SC Thin").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed SC Thin") does not match name table entry "Encode Sans Semi Cond SC Thin" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed SC Thin' but got 'Encode Sans Semi Cond SC Thin'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Semi Condensed SC Thin') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Semi Cond SC Thin') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Semi Condensed SC Thin' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, GPOS, fpgm, cvt , DSIG, gasp, prep, loca]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans Semi Condensed SC Thin | exceeds max length (31) |
