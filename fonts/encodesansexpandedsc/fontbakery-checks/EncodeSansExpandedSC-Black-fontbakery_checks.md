...
<details>
<summary><b>[118] EncodeSansExpandedSC-Black.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Expanded SC Black" while METADATA.pb has "Encode Sans Expanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd SC Black" while METADATA.pb has "Encode Sans Expanded SC Black". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Expanded SC Black" does not match post_script_name = "EncodeSansExpdSC-Black"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansExpandedSC-Black.ttf" does not match post_script_name="EncodeSansExpdSC-Black".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpdSC-Black") does not match correct font name format ("Encode Sans Expanded SC Black").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded SC Black") does not match name table entry "Encode Sans Expd SC Black" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded SC Black' but got 'Encode Sans Expd SC Black'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansExpandedSC-Black' but got 'EncodeSansExpdSC-Black'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded SC Black') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd SC Black') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1436 but it should be 1463 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Expanded SC Black' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesansexpandedsc/EncodeSansExpandedSC-Black.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [gasp, fpgm, GSUB, cvt , loca, prep, DSIG, GPOS]
...
* :bread: **PASS** fonts/encodesansexpandedsc/EncodeSansExpandedSC-Black.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansExpdSC-Black" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded SC' in 'Encode Sans Expanded SC Black')
