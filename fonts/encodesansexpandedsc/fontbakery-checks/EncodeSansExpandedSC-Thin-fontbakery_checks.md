...
<details>
<summary><b>[118] EncodeSansExpandedSC-Thin.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Expanded SC Thin" while METADATA.pb has "Encode Sans Expanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd SC Thin" while METADATA.pb has "Encode Sans Expanded SC Thin". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpdSC-Thin") does not match correct font name format ("Encode Sans Expanded SC Thin").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded SC Thin") does not match name table entry "Encode Sans Expd SC Thin" ! [code: fullname-mismatch]
...
* :information_source: **INFO** This font contains the following optional tables [prep, DSIG, GPOS, GSUB, loca, gasp, fpgm, cvt ]
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded SC' in 'Encode Sans Expanded SC Thin')
