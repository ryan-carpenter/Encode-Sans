...
|  | fonts/encodesansexpanded_sc/EncodeSansExpandedSC-Regular.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, gasp, GSUB, prep, loca, GPOS, fpgm, cvt ]
...
* :bread: **PASS** fonts/encodesansexpanded_sc/EncodeSansExpandedSC-Regular.ttf is named canonically.
