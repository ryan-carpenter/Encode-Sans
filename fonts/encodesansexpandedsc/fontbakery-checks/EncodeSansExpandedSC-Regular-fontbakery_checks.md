...
<details>
<summary><b>[118] EncodeSansExpandedSC-Regular.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd SC Reg" while METADATA.pb has "Encode Sans Expanded SC Regular". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Expanded SC Regular" does not match post_script_name = "EncodeSansExpdSC-Reg"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansExpandedSC-Regular.ttf" does not match post_script_name="EncodeSansExpdSC-Reg".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpdSC-Reg") does not match correct font name format ("Encode Sans Expanded SC").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded SC Regular") does not match name table entry "Encode Sans Expd SC Reg" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansExpdSC-Reg") and weight value (400). The name must be ended with "Regular" or "Italic".
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1256 but it should be 1284 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, GPOS, fpgm, loca, gasp, cvt , prep, GSUB]
...
* :bread: **PASS** Family name "Encode Sans Expanded SC" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Postscript name "EncodeSansExpdSC-Reg" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded SC' in 'Encode Sans Expanded SC Regular')
