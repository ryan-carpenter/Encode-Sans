...
<details>
<summary><b>[118] EncodeSansExpandedSC-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Expanded SC Light" while METADATA.pb has "Encode Sans Expanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd SC Lght" while METADATA.pb has "Encode Sans Expanded SC Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Expanded SC Light" does not match post_script_name = "EncodeSansExpdSC-Lght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansExpandedSC-Light.ttf" does not match post_script_name="EncodeSansExpdSC-Lght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpdSC-Lght") does not match correct font name format ("Encode Sans Expanded SC Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded SC Light") does not match name table entry "Encode Sans Expd SC Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansExpdSC-Lght") and weight value (300). The name must be ended with "Light" or "LightItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded SC Light' but got 'Encode Sans Expd SC Lght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansExpandedSC-Light' but got 'EncodeSansExpdSC-Lght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded SC Light') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd SC Lght') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1229 but it should be 1257 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Expanded SC Light' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesansexpandedsc/EncodeSansExpandedSC-Light.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GPOS, loca, cvt , DSIG, gasp, GSUB, prep]
...
* :bread: **PASS** fonts/encodesansexpandedsc/EncodeSansExpandedSC-Light.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansExpdSC-Lght" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded SC' in 'Encode Sans Expanded SC Light')
