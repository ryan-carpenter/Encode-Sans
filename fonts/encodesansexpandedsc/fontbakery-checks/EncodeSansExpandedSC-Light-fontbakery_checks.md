...
|  | fonts/encodesansexpanded_sc/EncodeSansExpandedSC-Light.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, gasp, cvt , fpgm, GPOS, prep, GSUB, loca]
...
* :bread: **PASS** fonts/encodesansexpanded_sc/EncodeSansExpandedSC-Light.ttf is named canonically.
