...
<details>
<summary><b>[118] EncodeSansExpandedSC-Bold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd SC Bold" while METADATA.pb has "Encode Sans Expanded SC Bold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Expanded SC Bold" does not match post_script_name = "EncodeSansExpdSC-Bold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansExpandedSC-Bold.ttf" does not match post_script_name="EncodeSansExpdSC-Bold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpdSC-Bold") does not match correct font name format ("Encode Sans Expanded SC").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded SC Bold") does not match name table entry "Encode Sans Expd SC Bold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded SC Bold' but got 'Encode Sans Expd SC Bold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansExpandedSC-Bold' but got 'EncodeSansExpdSC-Bold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded SC') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd SC Bold') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1356 but it should be 1384 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Expanded SC' / SUBFAMILY_NAME = 'Bold'
...
|  | fonts/encodesansexpandedsc/EncodeSansExpandedSC-Bold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [cvt , GSUB, loca, GPOS, fpgm, prep, DSIG, gasp]
...
* :bread: **PASS** fonts/encodesansexpandedsc/EncodeSansExpandedSC-Bold.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansExpdSC-Bold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded SC' in 'Encode Sans Expanded SC Bold')
