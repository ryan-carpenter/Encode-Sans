...
<details>
<summary><b>[117] EncodeSansExpandedSC-Bold.ttf</b></summary>
<details>
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1356 but it should be 1384 which corresponds to the average of the widths of all glyphs in the font.
...
* :information_source: **INFO** This font contains the following optional tables [loca, DSIG, prep, GPOS, gasp, cvt , GSUB, fpgm]
