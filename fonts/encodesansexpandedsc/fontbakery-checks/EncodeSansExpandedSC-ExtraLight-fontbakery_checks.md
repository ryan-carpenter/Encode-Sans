...
<details>
<summary><b>[118] EncodeSansExpandedSC-ExtraLight.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Expanded SC ExtraLight" while METADATA.pb has "Encode Sans Expanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansExpdSC-XLght" while METADATA.pb has "EncodeSansExpdSC-ExLght". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd SC XLght" while METADATA.pb has "Encode Sans Expanded SC ExtraLight". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Expanded SC ExtraLight" does not match post_script_name = "EncodeSansExpdSC-ExLght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansExpandedSC-ExtraLight.ttf" does not match post_script_name="EncodeSansExpdSC-ExLght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpdSC-ExLght") does not match correct font name format ("Encode Sans Expanded SC ExtraLight").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded SC ExtraLight") does not match name table entry "Encode Sans Expd SC XLght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansExpdSC-ExLght") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded SC ExtraLight' but got 'Encode Sans Expd SC XLght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansExpandedSC-ExtraLight' but got 'EncodeSansExpdSC-XLght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded SC ExtraLight') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd SC XLght') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1211 but it should be 1239 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Expanded SC ExtraLight' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesansexpandedsc/EncodeSansExpandedSC-ExtraLight.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, prep, GSUB, fpgm, gasp, DSIG, cvt , loca]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans Expanded SC ExtraLight | exceeds max length (31) |
...
* :bread: **PASS** fonts/encodesansexpandedsc/EncodeSansExpandedSC-ExtraLight.ttf is named canonically.
...
* :bread: **PASS** OK: Family name "Encode Sans Expanded SC" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded SC' in 'Encode Sans Expanded SC ExtraLight')
