...
<details>
<summary><b>[118] EncodeSansExpandedSC-SemiBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Expanded SC SemiBold" while METADATA.pb has "Encode Sans Expanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd SC SemiBold" while METADATA.pb has "Encode Sans Expanded SC SemiBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Expanded SC SemiBold" does not match post_script_name = "EncodeSansExpdSC-SemiBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansExpandedSC-SemiBold.ttf" does not match post_script_name="EncodeSansExpdSC-SemiBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpdSC-SemiBold") does not match correct font name format ("Encode Sans Expanded SC SemiBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded SC SemiBold") does not match name table entry "Encode Sans Expd SC SemiBold" ! [code: fullname-mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1321 but it should be 1349 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [loca, fpgm, GPOS, gasp, cvt , prep, DSIG, GSUB]
...
* :bread: **PASS** Postscript name "EncodeSansExpdSC-SemiBold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded SC' in 'Encode Sans Expanded SC SemiBold')
