...
<details>
<summary><b>[118] EncodeSansExpandedSC-Medium.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Expanded SC Medium" while METADATA.pb has "Encode Sans Expanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd SC Med" while METADATA.pb has "Encode Sans Expanded SC Medium". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Expanded SC Medium" does not match post_script_name = "EncodeSansExpdSC-Med"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansExpandedSC-Medium.ttf" does not match post_script_name="EncodeSansExpdSC-Med".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpdSC-Med") does not match correct font name format ("Encode Sans Expanded SC Medium").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded SC Medium") does not match name table entry "Encode Sans Expd SC Med" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansExpdSC-Med") and weight value (500). The name must be ended with "Medium" or "MediumItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded SC Medium' but got 'Encode Sans Expd SC Med'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansExpandedSC-Medium' but got 'EncodeSansExpdSC-Med'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded SC Medium') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd SC Med') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1286 but it should be 1314 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Expanded SC Medium' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesansexpandedsc/EncodeSansExpandedSC-Medium.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [gasp, GSUB, prep, GPOS, loca, DSIG, cvt , fpgm]
...
* :bread: **PASS** fonts/encodesansexpandedsc/EncodeSansExpandedSC-Medium.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansExpdSC-Med" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded SC' in 'Encode Sans Expanded SC Medium')
