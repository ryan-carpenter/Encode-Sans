...
<details>
<summary><b>[118] EncodeSansExpandedSC-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Expanded SC ExtraBold" while METADATA.pb has "Encode Sans Expanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansExpdSC-XBold" while METADATA.pb has "EncodeSansExpdSC-ExBold". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd SC XBold" while METADATA.pb has "Encode Sans Expanded SC ExtraBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Expanded SC ExtraBold" does not match post_script_name = "EncodeSansExpdSC-ExBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansExpandedSC-ExtraBold.ttf" does not match post_script_name="EncodeSansExpdSC-ExBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpdSC-ExBold") does not match correct font name format ("Encode Sans Expanded SC ExtraBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded SC ExtraBold") does not match name table entry "Encode Sans Expd SC XBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansExpdSC-ExBold") and weight value (800). The name must be ended with "ExtraBold" or "ExtraBoldItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded SC ExtraBold' but got 'Encode Sans Expd SC XBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansExpandedSC-ExtraBold' but got 'EncodeSansExpdSC-XBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded SC ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd SC XBold') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1395 but it should be 1422 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Expanded SC ExtraBold' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesansexpandedsc/EncodeSansExpandedSC-ExtraBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [gasp, loca, GSUB, DSIG, GPOS, prep, cvt , fpgm]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans Expanded SC ExtraBold | exceeds max length (31) |
...
* :bread: **PASS** fonts/encodesansexpandedsc/EncodeSansExpandedSC-ExtraBold.ttf is named canonically.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded SC' in 'Encode Sans Expanded SC ExtraBold')
