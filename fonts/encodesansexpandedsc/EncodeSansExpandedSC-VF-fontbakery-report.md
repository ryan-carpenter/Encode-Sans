...
|  | fonts/encodesansexpanded_sc/EncodeSansExpandedSC-VF.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [prep, GSUB, DSIG, cvt , GPOS, loca, fpgm, gasp]
...
* :bread: **PASS** fonts/encodesansexpanded_sc/EncodeSansExpandedSC-VF.ttf is named canonically.
