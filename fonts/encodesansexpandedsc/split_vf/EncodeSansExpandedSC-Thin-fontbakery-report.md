...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpdSC-Thin") does not match correct font name format ("Encode Sans Expanded SC").
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded SC Thin' but got 'Encode Sans Expanded SC'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded SC') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd SC Thin') [code: does-not]
...
* :information_source: **INFO** This font contains the following optional tables [cvt , gasp, prep, GSUB, GPOS, DSIG, loca, fpgm]
