...
<details>
<summary><b>[117] EncodeSansExpandedSC-Medium.ttf</b></summary>
<details>
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1286 but it should be 1314 which corresponds to the average of the widths of all glyphs in the font.
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, cvt , fpgm, prep, GPOS, GSUB, gasp, loca]
