...
<details>
<summary><b>[117] EncodeSansExpandedSC-Light.ttf</b></summary>
<details>
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1229 but it should be 1257 which corresponds to the average of the widths of all glyphs in the font.
...
* :information_source: **INFO** This font contains the following optional tables [loca, prep, gasp, cvt , GPOS, GSUB, fpgm, DSIG]
