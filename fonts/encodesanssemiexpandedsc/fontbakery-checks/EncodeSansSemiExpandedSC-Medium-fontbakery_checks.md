...
<details>
<summary><b>[118] EncodeSansSemiExpandedSC-Medium.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiExpanded SC Medium" while METADATA.pb has "Encode Sans SemiExpanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd SC Med" while METADATA.pb has "Encode Sans SemiExpanded SC Medium". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded SC Medium" does not match post_script_name = "EncodeSansSemiExpdSC-Med"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpandedSC-Medium.ttf" does not match post_script_name="EncodeSansSemiExpdSC-Med".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpdSC-Med") does not match correct font name format ("Encode Sans SemiExpanded SC Medium").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SC Medium") does not match name table entry "Encode Sans SemiExpd SC Med" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiExpdSC-Med") and weight value (500). The name must be ended with "Medium" or "MediumItalic".
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1216 but it should be 1244 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [gasp, loca, GSUB, DSIG, cvt , GPOS, prep, fpgm]
...
* :bread: **PASS** Postscript name "EncodeSansSemiExpdSC-Med" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiExpanded SC' in 'Encode Sans SemiExpanded SC Medium')
