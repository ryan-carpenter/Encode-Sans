...
<details>
<summary><b>[118] EncodeSansSemiExpandedSC-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiExpanded SC Light" while METADATA.pb has "Encode Sans SemiExpanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd SC Lght" while METADATA.pb has "Encode Sans SemiExpanded SC Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded SC Light" does not match post_script_name = "EncodeSansSemiExpdSC-Lght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpandedSC-Light.ttf" does not match post_script_name="EncodeSansSemiExpdSC-Lght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpdSC-Lght") does not match correct font name format ("Encode Sans SemiExpanded SC Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SC Light") does not match name table entry "Encode Sans SemiExpd SC Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiExpdSC-Lght") and weight value (300). The name must be ended with "Light" or "LightItalic".
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1162 but it should be 1190 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [loca, GSUB, DSIG, fpgm, prep, gasp, cvt , GPOS]
...
* :bread: **PASS** Postscript name "EncodeSansSemiExpdSC-Lght" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiExpanded SC' in 'Encode Sans SemiExpanded SC Light')
