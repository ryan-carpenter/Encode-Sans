...
<details>
<summary><b>[118] EncodeSansSemiExpandedSC-Regular.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd SC Reg" while METADATA.pb has "Encode Sans SemiExpanded SC Regular". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded SC Regular" does not match post_script_name = "EncodeSansSemiExpdSC-Reg"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpandedSC-Regular.ttf" does not match post_script_name="EncodeSansSemiExpdSC-Reg".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpdSC-Reg") does not match correct font name format ("Encode Sans SemiExpanded SC").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SC Regular") does not match name table entry "Encode Sans SemiExpd SC Reg" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiExpdSC-Reg") and weight value (400). The name must be ended with "Regular" or "Italic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC Regular' but got 'Encode Sans SemiExpd SC Reg'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiExpandedSC-Regular' but got 'EncodeSansSemiExpdSC-Reg'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiExpanded SC') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiExpd SC Reg') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1187 but it should be 1215 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans SemiExpanded SC' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanssemiexpandedsc/EncodeSansSemiExpandedSC-Regular.ttf |
|:--- | ---:|
| Dehinted Size | 89.5kb |
| Hinted Size | 120.0kb |
| Increase | 30.5kb |
| Change   | 34.1 % |
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, GSUB, loca, fpgm, gasp, prep, cvt , DSIG]
...
* :bread: **PASS** fonts/encodesanssemiexpandedsc/EncodeSansSemiExpandedSC-Regular.ttf is named canonically.
...
* :bread: **PASS** Family name "Encode Sans SemiExpanded SC" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Postscript name "EncodeSansSemiExpdSC-Reg" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiExpanded SC' in 'Encode Sans SemiExpanded SC Regular')
