...
<details>
<summary><b>[118] EncodeSansSemiExpandedSC-SemiBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiExpanded SC SemiBold" while METADATA.pb has "Encode Sans SemiExpanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd SC SemiBold" while METADATA.pb has "Encode Sans SemiExpanded SC SemiBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded SC SemiBold" does not match post_script_name = "EncodeSansSemiExpdSC-SemiBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpandedSC-SemiBold.ttf" does not match post_script_name="EncodeSansSemiExpdSC-SemiBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpdSC-SemiBold") does not match correct font name format ("Encode Sans SemiExpanded SC SemiBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SC SemiBold") does not match name table entry "Encode Sans SemiExpd SC SemiBold" ! [code: fullname-mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1248 but it should be 1276 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [cvt , DSIG, gasp, prep, GSUB, fpgm, GPOS, loca]
...
* :bread: **PASS** Postscript name "EncodeSansSemiExpdSC-SemiBold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiExpanded SC' in 'Encode Sans SemiExpanded SC SemiBold')
