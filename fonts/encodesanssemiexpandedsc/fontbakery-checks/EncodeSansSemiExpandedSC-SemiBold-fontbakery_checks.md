...
|  | fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-SemiBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, GPOS, GSUB, loca, gasp, cvt , prep, fpgm]
...
* :bread: **PASS** fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-SemiBold.ttf is named canonically.
