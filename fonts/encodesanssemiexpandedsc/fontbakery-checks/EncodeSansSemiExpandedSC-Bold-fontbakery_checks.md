...
<details>
<summary><b>[118] EncodeSansSemiExpandedSC-Bold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd SC Bold" while METADATA.pb has "Encode Sans SemiExpanded SC Bold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded SC Bold" does not match post_script_name = "EncodeSansSemiExpdSC-Bold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpandedSC-Bold.ttf" does not match post_script_name="EncodeSansSemiExpdSC-Bold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpdSC-Bold") does not match correct font name format ("Encode Sans SemiExpanded SC").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SC Bold") does not match name table entry "Encode Sans SemiExpd SC Bold" ! [code: fullname-mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1282 but it should be 1310 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [gasp, GPOS, GSUB, prep, DSIG, fpgm, cvt , loca]
...
* :bread: **PASS** Postscript name "EncodeSansSemiExpdSC-Bold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiExpanded SC' in 'Encode Sans SemiExpanded SC Bold')
