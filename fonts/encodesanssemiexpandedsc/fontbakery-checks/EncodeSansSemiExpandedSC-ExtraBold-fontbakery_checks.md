...
* :bread: **PASS** fonts/encodesanssemiexpanded_sc/DESCRIPTION.en_us.html is a propper HTML file.
...
|  | fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-ExtraBold.ttf |
|:--- | ---:|
| Dehinted Size | 80.8kb |
| Hinted Size | 110.9kb |
| Increase | 30.2kb |
| Change   | 37.3 % |
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, loca, cvt , GPOS, gasp, prep, DSIG, fpgm]
...
* :bread: **PASS** fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-ExtraBold.ttf is named canonically.
