...
* :fire: **FAIL** METADATA.pb: Copyright field value is inconsistent across family
...
* :bread: **PASS** fonts/encodesanssemiexpandedsc/DESCRIPTION.en_us.html is a propper HTML file.
...
<details>
<summary><b>[118] EncodeSansSemiExpandedSC-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiExpanded SC ExtraBold" while METADATA.pb has "Encode Sans SemiExpanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansSemiExpdSC-XBold" while METADATA.pb has "EncodeSansSemiExpdSC-ExBold". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd SC XBold" while METADATA.pb has "Encode Sans SemiExpanded SC ExtraBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded SC ExtraBold" does not match post_script_name = "EncodeSansSemiExpdSC-ExBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpandedSC-ExtraBold.ttf" does not match post_script_name="EncodeSansSemiExpdSC-ExBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpdSC-ExBold") does not match correct font name format ("Encode Sans SemiExpanded SC ExtraBold").
...
But instead we have got: 'Copyright 2012 The Encode Project Authors (impallari@gmail.com), with Reserved Font Name "Encode Sans".'
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SC ExtraBold") does not match name table entry "Encode Sans SemiExpd SC XBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiExpdSC-ExBold") and weight value (800). The name must be ended with "ExtraBold" or "ExtraBoldItalic".
...
* :fire: **FAIL** Copyright field for this font on METADATA.pb ('Copyright 2012 The Encode Project Authors (impallari@gmail.com), with Reserved Font Name "Encode Sans".') differs from a copyright notice entry on the name table: 'Copyright 2018 The Encode Project Authors (https://github.com/thundernixon/Encode-Sans), with Reserved Font Name 'Encode Sans'.'
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC ExtraBold' but got 'Encode Sans SemiExpanded SC ExtraBold'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC ExtraBold' but got 'Encode Sans SemiExpd SC XBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiExpandedSC-ExtraBold' but got 'EncodeSansSemiExpdSC-XBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiExpanded SC ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiExpd SC XBold') [code: does-not]
...
* :warning: **WARN** METADATA.pb: copyright field ("Copyright 2012 The Encode Project Authors (impallari@gmail.com), with Reserved Font Name "Encode Sans".") contains "Reserved Font Name". This is an error except in a few specific rare cases.
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1318 but it should be 1346 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans SemiExpanded SC ExtraBold' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanssemiexpandedsc/EncodeSansSemiExpandedSC-ExtraBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [cvt , fpgm, DSIG, prep, gasp, GPOS, loca, GSUB]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans SemiExpanded SC ExtraBold | exceeds max length (31) |
...
* :bread: **PASS** fonts/encodesanssemiexpandedsc/EncodeSansSemiExpandedSC-ExtraBold.ttf is named canonically.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiExpanded SC' in 'Encode Sans SemiExpanded SC ExtraBold')
