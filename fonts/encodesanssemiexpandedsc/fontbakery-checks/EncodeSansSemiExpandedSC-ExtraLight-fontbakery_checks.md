...
<details>
<summary><b>[118] EncodeSansSemiExpandedSC-ExtraLight.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansSemiExpdSC-XLght" while METADATA.pb has "EncodeSansSemiExpdSC-ExLght". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded SC ExtraLight" does not match post_script_name = "EncodeSansSemiExpdSC-ExLght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpandedSC-ExtraLight.ttf" does not match post_script_name="EncodeSansSemiExpdSC-ExLght".
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiExpdSC-ExLght") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1145 but it should be 1173 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, prep, loca, fpgm, GSUB, gasp, cvt , GPOS]
