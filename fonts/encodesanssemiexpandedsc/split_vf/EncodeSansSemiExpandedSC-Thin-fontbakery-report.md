...
* :zzz: **SKIP** Font family at 'fonts/encodesanssemiexpandedsc/split_vf' lacks a METADATA.pb file.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC Thin' but got 'Encode Sans Semi Expd SC Thin'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Semi Expanded SC Thin') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Semi Expd SC Thin') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Semi Expanded SC Thin' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** This font contains the following optional tables [gasp, GPOS, GSUB, DSIG, cvt , loca, fpgm, prep]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans Semi Expanded SC Thin | exceeds max length (31) |
