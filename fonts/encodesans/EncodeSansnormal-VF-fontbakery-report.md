...
<details>
<summary><b>[118] EncodeSansnormal-VF.ttf</b></summary>
<details>
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans normal' / SUBFAMILY_NAME = 'Thin'
...
|  | fonts/encodesans/EncodeSansnormal-VF.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [loca, fpgm, gasp, GSUB, GPOS, DSIG, cvt , prep]
...
* :bread: **PASS** fonts/encodesans/EncodeSansnormal-VF.ttf is named canonically.
