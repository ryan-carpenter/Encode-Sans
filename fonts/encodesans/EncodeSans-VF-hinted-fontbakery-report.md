...
* :fire: **FAIL** Style name used in "fonts/encodesans/EncodeSans-VF-hinted.ttf" is not canonical. You should rebuild the font using any of the following style names: "Thin", "ExtraLight", "Light", "Regular", "Medium", "SemiBold", "Bold", "ExtraBold", "Black", "Thin Italic", "ExtraLight Italic", "Light Italic", "Italic", "Medium Italic", "SemiBold Italic", "Bold Italic", "ExtraBold Italic", "Black Italic".
...
|  | fonts/encodesans/EncodeSans-VF-hinted.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GSUB, loca, cvt , prep, gasp, GPOS, DSIG]
