...
<details>
<summary><b>[115] EncodeSans-SemiBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiBold" while METADATA.pb has "Encode Sans" [code: mismatch]
...
* :fire: **FAIL** METADATA.pb Family name "Encode Sans") does not match name table entry "Encode Sans SemiBold" ! [code: familyname-mismatch]
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [germandbls.sc, uni1E1C, Dcroat, scedilla.sc, otilde, eogonek.sc, iogonek.sc, uni1E09, .notdef, utilde, uni1E4D, uni1EF9, atilde, uni03030304, Iogonek, Oslashacute, aogonek.sc, Eth, uni03030308, at, uni1E79, eth.sc, uni1EBD, scedilla, Tbar, hbar, tildecomb, iogonek, tbar, itilde, uni1E4F, dcroat, oslash, uni022D, tbar.sc, tildecomb_acutecomb, uni1E1D, uni1E9E, Ccedilla, oslash.sc, uni20B1.tf, Scedilla, hbar.sc, dcroat.sc, Hbar, lslash.sc, Lslash, oslashacute, lslash, ntilde, tilde, OE, Eogonek, ccedilla, oslashacute.sc, Aogonek, uni1E08, Oslash]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans SemiBold' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesans/static/EncodeSans-SemiBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [prep, gasp, GSUB, cvt , DSIG, loca, GPOS, fpgm]
...
* :bread: **PASS** fonts/encodesans/static/EncodeSans-SemiBold.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSans-SemiBold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Encode Sans SemiBold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans' in 'Encode Sans SemiBold')
