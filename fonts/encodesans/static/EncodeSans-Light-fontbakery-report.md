...
<details>
<summary><b>[115] EncodeSans-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Light" while METADATA.pb has "Encode Sans" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Lght" while METADATA.pb has "Encode Sans Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Light" does not match post_script_name = "EncodeSans-Lght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSans-Light.ttf" does not match post_script_name="EncodeSans-Lght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSans-Lght") does not match correct font name format ("Encode Sans Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Light") does not match name table entry "Encode Sans Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSans-Lght") and weight value (300). The name must be ended with "Light" or "LightItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Light' but got 'Encode Sans Lght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSans-Light' but got 'EncodeSans-Lght'.
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [uni1EEC, tbar.sc, uni1E44, uni1E15.sc, uni1EBE, uni0216, N, Uacute, perthousand, uni1EE4, OE, uni01CB, uni1EE6, Eacute, uni01C6, Wacute, Egrave, aeacute.sc, uni1E7A, Ntilde, uni1E42, Nacute, Ubreve, uni1E78, Oslashacute, uni2116, iacute_j.loclNLD, wgrave.sc, Emacron, M, uni01C9, Hbar, uni1EB8, uni1EC4, oslashacute.sc, Ecircumflex, uni20A9, uni1E17.sc, uni0204, uni1EF0, Umacron, Edotaccent, Ncaron, threeeighths, uni1EE8, Udieresis, uni1EEA, Lslash, Utilde, uni01F1, uni01F2, Ecaron, Uring, peseta, uni1E48, tbar, Edieresis, at, uni01CC, sterling.tf, oslash.sc, germandbls.sc, Wdieresis, uni1EC0, uni0206, uni01C4, m.sc, uni1EC6, hbar.sc, uni1E14, product, uni0214, uni1EC2, wdieresis.sc, uni01F3.sc, Ebreve, .notdef, Uhungarumlaut, uni1EEE, Ugrave, AE, uni1EBA, uni01C5, Ucircumflex, sterling, uni1E9E, wacute.sc, Oslash, uni01C6.sc, uni01C8, Eng, uni20BF, wcircumflex.sc, i_j.loclNLD, Wgrave, uni1EBC, uni01F3, uni01CA, lslash.sc, uni1E16, Wcircumflex, Amacron, uni1E46, uni1E43.sc, AEacute, lslash, E, W, uni01CC.sc]
...
* :bread: **PASS** fonts/encodesans/static/EncodeSans-Light.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSans-Lght" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans' in 'Encode Sans Light')
