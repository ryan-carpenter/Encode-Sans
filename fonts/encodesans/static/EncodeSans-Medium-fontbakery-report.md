...
<details>
<summary><b>[115] EncodeSans-Medium.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Medium" while METADATA.pb has "Encode Sans" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Med" while METADATA.pb has "Encode Sans Medium". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Medium" does not match post_script_name = "EncodeSans-Med"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSans-Medium.ttf" does not match post_script_name="EncodeSans-Med".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSans-Med") does not match correct font name format ("Encode Sans Medium").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Medium") does not match name table entry "Encode Sans Med" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSans-Med") and weight value (500). The name must be ended with "Medium" or "MediumItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Medium' but got 'Encode Sans Med'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSans-Medium' but got 'EncodeSans-Med'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Medium') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Med') [code: does-not]
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [tbar, uni1EBD, uni1E9E, hbar, uni1EF9, dcroat.sc, oslash.sc, utilde, tbar.sc, Lslash, tildecomb_acutecomb, uni03030304, eth.sc, Eogonek, dcroat, uni1E79, hbar.sc, aogonek.sc, Oslash, atilde, lslash.sc, uni03030308, itilde, uni1E4F, Tbar, .notdef, oslashacute.sc, Dcroat, oslashacute, lslash, otilde, ntilde, Eth, uni022D, uni1E4D, germandbls.sc, oslash, Oslashacute, tildecomb, tilde, Hbar]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Medium' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesans/static/EncodeSans-Medium.ttf |
|:--- | ---:|
| Dehinted Size | 115.7kb |
| Hinted Size | 152.8kb |
| Increase | 37.1kb |
| Change   | 32.0 % |
...
* :information_source: **INFO** This font contains the following optional tables [cvt , GSUB, gasp, loca, DSIG, prep, GPOS, fpgm]
...
* :bread: **PASS** fonts/encodesans/static/EncodeSans-Medium.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSans-Med" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans' in 'Encode Sans Medium')
