...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [tbar.sc, Tbar, dcroat, Dcroat, hbar.sc, lslash, Oslashacute, tbar, oslashacute.sc, Eth, Hbar, Oslash, lslash.sc, oslash.sc, aogonek.sc, .notdef, Lslash, Eogonek, dcroat.sc, germandbls.sc, hbar, eth.sc, uni1E9E]
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, DSIG, gasp, loca, fpgm, prep, cvt , GSUB]
