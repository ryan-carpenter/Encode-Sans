...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [Dcroat, dcroat.sc, Eth, tbar.sc, Tbar, aogonek.sc, .notdef, tbar, Oslash, germandbls.sc, Lslash, Oslashacute, lslash, uni1E9E, hbar, eth.sc, oslashacute.sc, dcroat, lslash.sc, Eogonek, oslash.sc, Hbar, hbar.sc]
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, GPOS, fpgm, GSUB, cvt , prep, loca, gasp]
