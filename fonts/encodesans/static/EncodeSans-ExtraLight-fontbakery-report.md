...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans ExtraLight" while METADATA.pb has "Encode Sans" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans ExLght" while METADATA.pb has "Encode Sans ExtraLight". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans ExtraLight" does not match post_script_name = "EncodeSans-ExLght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSans-ExtraLight.ttf" does not match post_script_name="EncodeSans-ExLght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSans-ExLght") does not match correct font name format ("Encode Sans ExtraLight").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans ExtraLight") does not match name table entry "Encode Sans ExLght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSans-ExLght") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans ExtraLight' but got 'Encode Sans ExLght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSans-ExtraLight' but got 'EncodeSans-ExLght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans ExtraLight') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans ExLght') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans ExtraLight' / SUBFAMILY_NAME = 'Regular'
...
* :bread: **PASS** fonts/encodesans/static/EncodeSans-ExtraLight.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSans-ExLght" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans' in 'Encode Sans ExtraLight')
