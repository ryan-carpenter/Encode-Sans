...
<details>
<summary><b>[118] EncodeSans-Regular.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Reg" while METADATA.pb has "Encode Sans Regular". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Regular" does not match post_script_name = "EncodeSans-Reg"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSans-Regular.ttf" does not match post_script_name="EncodeSans-Reg".
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Regular") does not match name table entry "Encode Sans Reg" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSans-Reg") and weight value (400). The name must be ended with "Regular" or "Italic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Regular' but got 'Encode Sans Reg'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSans-Regular' but got 'EncodeSans-Reg'.
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [Eth, oslash.sc, tbar.sc, dcroat, dcroat.sc, Oslash, Oslashacute, .notdef, Hbar, lslash.sc, eth.sc, Tbar, Lslash, hbar, tbar, lslash, germandbls.sc, hbar.sc, uni1E9E, Dcroat, oslashacute.sc]
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, DSIG, loca, GSUB, fpgm, gasp, prep, cvt ]
...
* :bread: **PASS** fonts/encodesans/static/EncodeSans-Regular.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSans-Reg" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans' in 'Encode Sans Regular')
