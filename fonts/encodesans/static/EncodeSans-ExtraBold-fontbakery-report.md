...
<details>
<summary><b>[115] EncodeSans-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans ExtraBold" while METADATA.pb has "Encode Sans" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans ExBold" while METADATA.pb has "Encode Sans ExtraBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans ExtraBold" does not match post_script_name = "EncodeSans-ExBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSans-ExtraBold.ttf" does not match post_script_name="EncodeSans-ExBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSans-ExBold") does not match correct font name format ("Encode Sans ExtraBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans ExtraBold") does not match name table entry "Encode Sans ExBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSans-ExBold") and weight value (800). The name must be ended with "ExtraBold" or "ExtraBoldItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans ExtraBold' but got 'Encode Sans ExBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSans-ExtraBold' but got 'EncodeSans-ExBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans ExBold') [code: does-not]
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [oslash.sc, dcroat, tildecomb, Tbar, hbar.sc, uni03030308, tbar, Aogonek, scedilla, hbar, uni03030304, iogonek, lslash, uni1E08, itilde, Scedilla, oslashacute, uni1E09, Hbar, atilde, iogonek.sc, eogonek.sc, uni022D, Iogonek, .notdef, uni1E4F, uni1E1D, scedilla.sc, tilde, eth.sc, utilde, Dcroat, Oslash, oslashacute.sc, germandbls.sc, uni1E79, uni1E4D, tbar.sc, Oslashacute, dcroat.sc, Ccedilla, lslash.sc, tildecomb_acutecomb, uni1EBD, otilde, oslash, Eth, Eogonek, aogonek.sc, uni1E9E, uni1EF9, uni0163, Lslash, ntilde, ccedilla]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans ExtraBold' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** This font contains the following optional tables [gasp, loca, GPOS, fpgm, GSUB, DSIG, prep, cvt ]
...
* :bread: **PASS** fonts/encodesans/static/EncodeSans-ExtraBold.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSans-ExBold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans' in 'Encode Sans ExtraBold')
