...
<details>
<summary><b>[115] EncodeSans-Black.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Black" while METADATA.pb has "Encode Sans" [code: mismatch]
...
* :fire: **FAIL** METADATA.pb Family name "Encode Sans") does not match name table entry "Encode Sans Black" ! [code: familyname-mismatch]
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [Hbar, tilde, uni1E9E, aogonek.sc, iogonek.sc, uni022D, ntilde, utilde, lslash, eth.sc, hbar.sc, oslashacute, iogonek, Eth, uni03030304, atilde, tbar, uni1EBD, uni1E4D, Oslashacute, Eogonek, tbar.sc, eogonek.sc, oslash, dcroat.sc, Oslash, uni1EF9, Iogonek, lslash.sc, uni03030308, oslash.sc, dcroat, uni1E79, hbar, Dcroat, Aogonek, itilde, germandbls.sc, Lslash, .notdef, uni1E4F, oslashacute.sc, otilde, Tbar, tildecomb_acutecomb, tildecomb]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Black' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesans/static/EncodeSans-Black.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, loca, fpgm, prep, gasp, GPOS, cvt , DSIG]
...
* :bread: **PASS** fonts/encodesans/static/EncodeSans-Black.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSans-Black" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Encode Sans Black" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans' in 'Encode Sans Black')
