...
* :warning: **WARN** OS/2 xAvgCharWidth is 1187 but it should be 1216 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [cvt , DSIG, GPOS, gasp, loca, prep, GSUB, fpgm]
