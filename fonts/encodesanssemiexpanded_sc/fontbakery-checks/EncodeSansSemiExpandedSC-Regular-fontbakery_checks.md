...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Expanded" while METADATA.pb has "Encode Sans SemiExpanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Expd Reg" while METADATA.pb has "Encode Sans SemiExpanded SC Regular". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiExpanded SC Regular") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpdSC-Reg") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SC Regular") does not match name table entry "Encode Sans Semi Expd Reg" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC' but got 'Encode Sans Semi Expanded'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC Regular' but got 'Encode Sans Semi Expd Reg'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Semi Expanded') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Semi Expd Reg') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Semi Expanded' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-Regular.ttf |
|:--- | ---:|
| Dehinted Size | 79.9kb |
| Hinted Size | 110.4kb |
| Increase | 30.5kb |
| Change   | 38.2 % |
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, loca, gasp, cvt , prep, GPOS, GSUB, DSIG]
...
* :bread: **PASS** fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-Regular.ttf is named canonically.
