...
* :warning: **WARN** OS/2 xAvgCharWidth is 1216 but it should be 1245 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [loca, gasp, fpgm, cvt , GSUB, DSIG, prep, GPOS]
