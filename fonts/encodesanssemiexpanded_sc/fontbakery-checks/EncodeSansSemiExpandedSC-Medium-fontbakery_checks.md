...
|  | fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-Medium.ttf |
|:--- | ---:|
| Dehinted Size | 80.1kb |
| Hinted Size | 111.4kb |
| Increase | 31.3kb |
| Change   | 39.1 % |
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GSUB, gasp, loca, DSIG, cvt , GPOS, prep]
...
* :bread: **PASS** fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-Medium.ttf is named canonically.
