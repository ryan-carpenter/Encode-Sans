...
* :warning: **WARN** OS/2 xAvgCharWidth is 1132 but it should be 1161 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, loca, GSUB, prep, cvt , fpgm, gasp, GPOS]
