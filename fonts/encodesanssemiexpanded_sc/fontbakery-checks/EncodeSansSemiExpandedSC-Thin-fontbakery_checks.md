...
|  | fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-Thin.ttf |
|:--- | ---:|
| Dehinted Size | 78.9kb |
| Hinted Size | 108.8kb |
| Increase | 29.9kb |
| Change   | 37.9 % |
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, fpgm, gasp, prep, GPOS, GSUB, cvt , loca]
...
* :bread: **PASS** fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-Thin.ttf is named canonically.
