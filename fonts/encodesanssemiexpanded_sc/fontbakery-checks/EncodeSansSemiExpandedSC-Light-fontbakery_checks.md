...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Expanded Light" while METADATA.pb has "Encode Sans SemiExpanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Expd Lght" while METADATA.pb has "Encode Sans SemiExpanded SC Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiExpanded SC Light") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpdSC-Lght") does not match correct font name format ("Encode Sans Semi Expanded Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SC Light") does not match name table entry "Encode Sans Semi Expd Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC Light' but got 'Encode Sans Semi Expanded Light'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC Light' but got 'Encode Sans Semi Expd Lght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Semi Expanded Light') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Semi Expd Lght') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Semi Expanded Light' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** This font contains the following optional tables [prep, loca, gasp, GSUB, fpgm, DSIG, cvt , GPOS]
