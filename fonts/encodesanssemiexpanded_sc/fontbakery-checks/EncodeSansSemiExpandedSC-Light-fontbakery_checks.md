...
|  | fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-Light.ttf |
|:--- | ---:|
| Dehinted Size | 80.4kb |
| Hinted Size | 111.9kb |
| Increase | 31.5kb |
| Change   | 39.2 % |
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, prep, fpgm, gasp, GPOS, cvt , GSUB, loca]
...
* :bread: **PASS** fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-Light.ttf is named canonically.
