...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Expd Bold" while METADATA.pb has "Encode Sans SemiExpanded SC Bold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiExpanded SC Bold") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpdSC-Bold") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SC Bold") does not match name table entry "Encode Sans Semi Expd Bold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC Bold' but got 'Encode Sans Semi Expd Bold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Semi Expanded') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Semi Expd Bold') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Semi Expanded' / SUBFAMILY_NAME = 'Bold'
...
|  | fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-Bold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, prep, fpgm, cvt , DSIG, loca, gasp, GSUB]
...
* :bread: **PASS** fonts/encodesanssemiexpanded_sc/EncodeSansSemiExpandedSC-Bold.ttf is named canonically.
