...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Expanded ExtraBold" while METADATA.pb has "Encode Sans SemiExpanded SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Expd XBold" while METADATA.pb has "Encode Sans SemiExpanded SC ExtraBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiExpanded SC ExtraBold") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpdSC-ExBold") does not match correct font name format ("Encode Sans Semi Expanded ExtraBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SC ExtraBold") does not match name table entry "Encode Sans Semi Expd XBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC ExtraBold' but got 'Encode Sans Semi Expanded ExtraBold'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SC ExtraBold' but got 'Encode Sans Semi Expd XBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Semi Expanded ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Semi Expd XBold') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Semi Expanded ExtraBold' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** This font contains the following optional tables [gasp, prep, fpgm, GPOS, GSUB, cvt , DSIG, loca]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans Semi Expanded ExtraBold | exceeds max length (31) |
