...
<details>
<summary><b>[115] EncodeSansSemiExpanded-ExtraLight.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded ExtraLight' but got 'Encode Sans SemiExpd ExLght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiExpanded-ExtraLight' but got 'EncodeSansSemiExpd-ExLght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiExpanded ExtraLight') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiExpd ExLght') [code: does-not]
...
|  | fonts/encodesanssemiexpanded/static/EncodeSansSemiExpanded-ExtraLight.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, fpgm, prep, loca, GPOS, GSUB, gasp, cvt ]
...
* :bread: **PASS** fonts/encodesanssemiexpanded/static/EncodeSansSemiExpanded-ExtraLight.ttf is named canonically.
