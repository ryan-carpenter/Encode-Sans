...
* :zzz: **SKIP** Font family at 'fonts/encodesanssemiexpanded/static' lacks a METADATA.pb file.
...
<details>
<summary><b>[115] EncodeSansSemiExpanded-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded ExtraBold' but got 'Encode Sans SemiExpd ExBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiExpanded-ExtraBold' but got 'EncodeSansSemiExpd-ExBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiExpanded ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiExpd ExBold') [code: does-not]
...
|  | fonts/encodesanssemiexpanded/static/EncodeSansSemiExpanded-ExtraBold.ttf |
|:--- | ---:|
| Dehinted Size | 116.7kb |
| Hinted Size | 155.3kb |
| Increase | 38.6kb |
| Change   | 33.1 % |
...
* :information_source: **INFO** This font contains the following optional tables [gasp, prep, cvt , fpgm, loca, GSUB, GPOS, DSIG]
...
* :bread: **PASS** fonts/encodesanssemiexpanded/static/EncodeSansSemiExpanded-ExtraBold.ttf is named canonically.
