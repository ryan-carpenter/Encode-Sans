...
<details>
<summary><b>[116] EncodeSansSemiExpanded-Thin.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansSemiExpd-Lght" while METADATA.pb has "EncodeSansSemiExpd-Thin". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd Lght" while METADATA.pb has "Encode Sans SemiExpanded Thin". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-Thin") does not match correct font name format ("Encode Sans SemiExpanded Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded Thin") does not match name table entry "Encode Sans SemiExpd Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded Thin' but got 'Encode Sans SemiExpanded Light'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded Thin' but got 'Encode Sans SemiExpd Lght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiExpanded-Thin' but got 'EncodeSansSemiExpd-Lght'.
