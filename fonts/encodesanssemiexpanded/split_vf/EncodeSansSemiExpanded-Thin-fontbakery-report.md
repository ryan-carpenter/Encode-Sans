...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-Thin") does not match correct font name format ("Encode Sans SemiExpanded").
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded Thin' but got 'Encode Sans SemiExpanded'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiExpanded') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiExpd Thin') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans SemiExpanded' / SUBFAMILY_NAME = 'Thin'
...
* :information_source: **INFO** This font contains the following optional tables [prep, GPOS, gasp, DSIG, fpgm, loca, cvt , GSUB]
