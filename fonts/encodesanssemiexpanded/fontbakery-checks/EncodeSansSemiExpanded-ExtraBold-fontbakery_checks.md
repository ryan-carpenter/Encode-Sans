...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Expanded ExtraBold" while METADATA.pb has "Encode Sans SemiExpanded" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Expd XBold" while METADATA.pb has "Encode Sans SemiExpanded ExtraBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiExpanded ExtraBold") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-ExBold") does not match correct font name format ("Encode Sans Semi Expanded ExtraBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded ExtraBold") does not match name table entry "Encode Sans Semi Expd XBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded ExtraBold' but got 'Encode Sans Semi Expd XBold'.
...
* :information_source: **INFO** This font contains the following optional tables [loca, fpgm, GPOS, prep, GSUB, gasp, DSIG, cvt ]
