...
<details>
<summary><b>[118] EncodeSansSemiExpanded-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiExpanded ExtraBold" while METADATA.pb has "Encode Sans SemiExpanded" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansSemiExpd-XBold" while METADATA.pb has "EncodeSansSemiExpd-ExBold". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd XBold" while METADATA.pb has "Encode Sans SemiExpanded ExtraBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded ExtraBold" does not match post_script_name = "EncodeSansSemiExpd-ExBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpanded-ExtraBold.ttf" does not match post_script_name="EncodeSansSemiExpd-ExBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-ExBold") does not match correct font name format ("Encode Sans SemiExpanded ExtraBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded ExtraBold") does not match name table entry "Encode Sans SemiExpd XBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiExpd-ExBold") and weight value (800). The name must be ended with "ExtraBold" or "ExtraBoldItalic".
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded ExtraBold' but got 'Encode Sans SemiExpanded ExtraBold'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded ExtraBold' but got 'Encode Sans SemiExpd XBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiExpanded-ExtraBold' but got 'EncodeSansSemiExpd-XBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiExpanded ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiExpd XBold') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans SemiExpanded ExtraBold' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanssemiexpanded/EncodeSansSemiExpanded-ExtraBold.ttf |
|:--- | ---:|
| Dehinted Size | 117.5kb |
| Hinted Size | 155.9kb |
| Increase | 38.5kb |
| Change   | 32.8 % |
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, fpgm, gasp, cvt , GSUB, loca, prep, GPOS]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans SemiExpanded ExtraBold | exceeds max length (31) |
...
* :bread: **PASS** fonts/encodesanssemiexpanded/EncodeSansSemiExpanded-ExtraBold.ttf is named canonically.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiExpanded' in 'Encode Sans SemiExpanded ExtraBold')
