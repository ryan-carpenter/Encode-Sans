...
<details>
<summary><b>[118] EncodeSansSemiExpanded-ExtraLight.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Expanded ExtraLight" while METADATA.pb has "Encode Sans SemiExpanded" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansSemiExpd-XLght" while METADATA.pb has "EncodeSansSemiExpd-ExLght". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Expd XLght" while METADATA.pb has "Encode Sans SemiExpanded ExtraLight". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded ExtraLight" does not match post_script_name = "EncodeSansSemiExpd-ExLght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpanded-ExtraLight.ttf" does not match post_script_name="EncodeSansSemiExpd-ExLght".
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiExpanded ExtraLight") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-ExLght") does not match correct font name format ("Encode Sans Semi Expanded ExtraLight").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded ExtraLight") does not match name table entry "Encode Sans Semi Expd XLght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiExpd-ExLght") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded ExtraLight' but got 'Encode Sans Semi Expd XLght'.
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, prep, DSIG, GSUB, gasp, cvt , loca, GPOS]
