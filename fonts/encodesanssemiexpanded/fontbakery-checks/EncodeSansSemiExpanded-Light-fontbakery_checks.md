...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Expanded Light" while METADATA.pb has "Encode Sans SemiExpanded" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Expd Lght" while METADATA.pb has "Encode Sans SemiExpanded Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiExpanded Light") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-Lght") does not match correct font name format ("Encode Sans Semi Expanded Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded Light") does not match name table entry "Encode Sans Semi Expd Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded Light' but got 'Encode Sans Semi Expd Lght'.
...
* :information_source: **INFO** This font contains the following optional tables [gasp, GSUB, DSIG, prep, loca, fpgm, GPOS, cvt ]
