...
<details>
<summary><b>[118] EncodeSansSemiExpanded-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiExpanded Light" while METADATA.pb has "Encode Sans SemiExpanded" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd Lght" while METADATA.pb has "Encode Sans SemiExpanded Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded Light" does not match post_script_name = "EncodeSansSemiExpd-Lght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpanded-Light.ttf" does not match post_script_name="EncodeSansSemiExpd-Lght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-Lght") does not match correct font name format ("Encode Sans SemiExpanded Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded Light") does not match name table entry "Encode Sans SemiExpd Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiExpd-Lght") and weight value (300). The name must be ended with "Light" or "LightItalic".
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded Light' but got 'Encode Sans SemiExpanded Light'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded Light' but got 'Encode Sans SemiExpd Lght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiExpanded-Light' but got 'EncodeSansSemiExpd-Lght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiExpanded Light') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiExpd Lght') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans SemiExpanded Light' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanssemiexpanded/EncodeSansSemiExpanded-Light.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [loca, prep, GSUB, cvt , gasp, fpgm, GPOS, DSIG]
...
* :bread: **PASS** fonts/encodesanssemiexpanded/EncodeSansSemiExpanded-Light.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansSemiExpd-Lght" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiExpanded' in 'Encode Sans SemiExpanded Light')
