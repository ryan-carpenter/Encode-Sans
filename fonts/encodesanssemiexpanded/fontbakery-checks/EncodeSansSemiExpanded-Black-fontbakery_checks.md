...
<details>
<summary><b>[118] EncodeSansSemiExpanded-Black.ttf</b></summary>
<details>
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded Black" does not match post_script_name = "EncodeSansSemiExpd-Black"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpanded-Black.ttf" does not match post_script_name="EncodeSansSemiExpd-Black".
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiExpanded-Black' but got 'EncodeSansSemiExpd-Black'.
...
* :information_source: **INFO** This font contains the following optional tables [gasp, DSIG, GPOS, fpgm, prep, cvt , GSUB, loca]
...
* :bread: **PASS** fonts/encodesanssemiexpanded/EncodeSansSemiExpanded-Black.ttf is named canonically.
