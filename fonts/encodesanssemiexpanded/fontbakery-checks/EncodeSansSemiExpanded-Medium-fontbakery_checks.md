...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded Medium" does not match post_script_name = "EncodeSansSemiExpd-Med"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpanded-Medium.ttf" does not match post_script_name="EncodeSansSemiExpd-Med".
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiExpd-Med") and weight value (500). The name must be ended with "Medium" or "MediumItalic".
...
* :information_source: **INFO** This font contains the following optional tables [loca, cvt , GSUB, fpgm, gasp, prep, DSIG, GPOS]
