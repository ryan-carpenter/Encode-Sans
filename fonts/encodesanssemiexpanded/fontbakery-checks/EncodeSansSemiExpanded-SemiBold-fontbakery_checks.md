...
<details>
<summary><b>[118] EncodeSansSemiExpanded-SemiBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiExpanded SemiBold" while METADATA.pb has "Encode Sans SemiExpanded" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd SemiBold" while METADATA.pb has "Encode Sans SemiExpanded SemiBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded SemiBold" does not match post_script_name = "EncodeSansSemiExpd-SemiBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpanded-SemiBold.ttf" does not match post_script_name="EncodeSansSemiExpd-SemiBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-SemiBold") does not match correct font name format ("Encode Sans SemiExpanded SemiBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SemiBold") does not match name table entry "Encode Sans SemiExpd SemiBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SemiBold' but got 'Encode Sans SemiExpanded SemiBold'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SemiBold' but got 'Encode Sans SemiExpd SemiBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiExpanded-SemiBold' but got 'EncodeSansSemiExpd-SemiBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiExpanded SemiBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiExpd SemiBold') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans SemiExpanded SemiBold' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanssemiexpanded/EncodeSansSemiExpanded-SemiBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, gasp, prep, loca, GSUB, GPOS, cvt , fpgm]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans SemiExpanded SemiBold | exceeds max length (31) |
...
* :bread: **PASS** fonts/encodesanssemiexpanded/EncodeSansSemiExpanded-SemiBold.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansSemiExpd-SemiBold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiExpanded' in 'Encode Sans SemiExpanded SemiBold')
