...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Expanded SemiBold" while METADATA.pb has "Encode Sans SemiExpanded" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Expd SemiBold" while METADATA.pb has "Encode Sans SemiExpanded SemiBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiExpanded SemiBold") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-SemiBold") does not match correct font name format ("Encode Sans Semi Expanded SemiBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded SemiBold") does not match name table entry "Encode Sans Semi Expd SemiBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded SemiBold' but got 'Encode Sans Semi Expd SemiBold'.
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, loca, fpgm, prep, GSUB, DSIG, cvt , gasp]
