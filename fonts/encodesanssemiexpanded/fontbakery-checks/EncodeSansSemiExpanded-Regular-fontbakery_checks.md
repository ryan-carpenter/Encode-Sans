...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Expanded" while METADATA.pb has "Encode Sans SemiExpanded" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Expd Reg" while METADATA.pb has "Encode Sans SemiExpanded Regular". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiExpanded Regular") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-Reg") does not match correct font name format ("Encode Sans Semi Expanded").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded Regular") does not match name table entry "Encode Sans Semi Expd Reg" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded Regular' but got 'Encode Sans Semi Expd Reg'.
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, loca, cvt , GSUB, prep, gasp, GPOS, fpgm]
