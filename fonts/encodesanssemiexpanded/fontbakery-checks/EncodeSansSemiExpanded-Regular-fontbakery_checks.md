...
<details>
<summary><b>[118] EncodeSansSemiExpanded-Regular.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiExpd Reg" while METADATA.pb has "Encode Sans SemiExpanded Regular". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiExpanded Regular" does not match post_script_name = "EncodeSansSemiExpd-Reg"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiExpanded-Regular.ttf" does not match post_script_name="EncodeSansSemiExpd-Reg".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiExpd-Reg") does not match correct font name format ("Encode Sans SemiExpanded").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiExpanded Regular") does not match name table entry "Encode Sans SemiExpd Reg" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiExpd-Reg") and weight value (400). The name must be ended with "Regular" or "Italic".
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded' but got 'Encode Sans SemiExpanded'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Expanded Regular' but got 'Encode Sans SemiExpd Reg'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiExpanded-Regular' but got 'EncodeSansSemiExpd-Reg'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiExpanded') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiExpd Reg') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans SemiExpanded' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanssemiexpanded/EncodeSansSemiExpanded-Regular.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [gasp, DSIG, GPOS, fpgm, cvt , prep, loca, GSUB]
...
* :bread: **PASS** fonts/encodesanssemiexpanded/EncodeSansSemiExpanded-Regular.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansSemiExpd-Reg" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiExpanded' in 'Encode Sans SemiExpanded Regular')
