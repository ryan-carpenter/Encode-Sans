...
<details>
<summary><b>[118] EncodeSansExpanded-Black.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Expanded Black" while METADATA.pb has "Encode Sans Expanded" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd Black" while METADATA.pb has "Encode Sans Expanded Black". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Expanded Black" does not match post_script_name = "EncodeSansExpd-Black"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansExpanded-Black.ttf" does not match post_script_name="EncodeSansExpd-Black".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpd-Black") does not match correct font name format ("Encode Sans Expanded Black").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded Black") does not match name table entry "Encode Sans Expd Black" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded Black' but got 'Encode Sans Expd Black'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansExpanded-Black' but got 'EncodeSansExpd-Black'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded Black') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd Black') [code: does-not]
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [aogonek.sc, iogonek, Eth, iogonek.sc, lslash.sc, oslash.sc, uni1E9E, dcroat.sc, Aogonek, uni1E09, uni1E1D, Eogonek, Dcroat, Oslash, Oslashacute, Lslash, lslash, tbar.sc, dcroat, hbar.sc, Iogonek, scedilla, ccedilla, eth.sc, oslashacute.sc, hbar, tbar, Scedilla, eogonek.sc, germandbls.sc, Tbar, .notdef, Hbar]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Expanded Black' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesansexpanded/EncodeSansExpanded-Black.ttf |
|:--- | ---:|
| Dehinted Size | 117.0kb |
| Hinted Size | 153.9kb |
| Increase | 36.8kb |
| Change   | 31.5 % |
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, fpgm, gasp, prep, cvt , loca, GPOS, GSUB]
...
* :bread: **PASS** fonts/encodesansexpanded/EncodeSansExpanded-Black.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansExpd-Black" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded' in 'Encode Sans Expanded Black')
