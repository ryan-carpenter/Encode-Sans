...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [Tbar, iogonek, uni1E1D, iogonek.sc, lslash, hbar.sc, eth.sc, Lslash, Iogonek, tbar, aogonek.sc, .notdef, uni1E9E, dcroat, lslash.sc, ccedilla, oslashacute.sc, Oslashacute, Scedilla, hbar, eogonek.sc, dcroat.sc, Dcroat, oslash.sc, Aogonek, Eth, Eogonek, tbar.sc, Hbar, Oslash, germandbls.sc, uni1E09, scedilla]
...
* :information_source: **INFO** This font contains the following optional tables [prep, fpgm, cvt , GSUB, GPOS, gasp, loca, DSIG]
