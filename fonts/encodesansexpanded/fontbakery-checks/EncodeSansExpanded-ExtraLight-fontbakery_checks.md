...
<details>
<summary><b>[118] EncodeSansExpanded-ExtraLight.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Expanded ExtraLight" while METADATA.pb has "Encode Sans Expanded" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansExpd-XLght" while METADATA.pb has "EncodeSansExpd-ExLght". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Expd XLght" while METADATA.pb has "Encode Sans Expanded ExtraLight". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Expanded ExtraLight" does not match post_script_name = "EncodeSansExpd-ExLght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansExpanded-ExtraLight.ttf" does not match post_script_name="EncodeSansExpd-ExLght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansExpd-ExLght") does not match correct font name format ("Encode Sans Expanded ExtraLight").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Expanded ExtraLight") does not match name table entry "Encode Sans Expd XLght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansExpd-ExLght") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded ExtraLight' but got 'Encode Sans Expd XLght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansExpanded-ExtraLight' but got 'EncodeSansExpd-XLght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded ExtraLight') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd XLght') [code: does-not]
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [hbar.sc, .notdef, Lslash, tbar, dcroat, Tbar, lslash.sc, Hbar, Eth, dcroat.sc, Dcroat, uni1E9E, lslash, Oslashacute, eth.sc, Oslash, germandbls.sc, hbar, oslash.sc, oslashacute.sc, tbar.sc]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Expanded ExtraLight' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesansexpanded/EncodeSansExpanded-ExtraLight.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, loca, fpgm, GPOS, prep, gasp, cvt , DSIG]
...
* :bread: **PASS** fonts/encodesansexpanded/EncodeSansExpanded-ExtraLight.ttf is named canonically.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Expanded' in 'Encode Sans Expanded ExtraLight')
