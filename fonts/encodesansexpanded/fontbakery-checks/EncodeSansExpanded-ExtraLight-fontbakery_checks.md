...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [hbar, Dcroat, tbar, oslashacute.sc, .notdef, Lslash, Eth, Oslash, Tbar, tbar.sc, lslash, Oslashacute, dcroat, Hbar, oslash.sc, uni1E9E, lslash.sc, eth.sc, dcroat.sc, hbar.sc, germandbls.sc]
...
* :information_source: **INFO** This font contains the following optional tables [cvt , gasp, loca, GPOS, fpgm, GSUB, DSIG, prep]
