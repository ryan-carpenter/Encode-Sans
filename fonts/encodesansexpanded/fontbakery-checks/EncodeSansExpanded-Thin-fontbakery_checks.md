...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Expanded Thin" while METADATA.pb has "Encode Sans Expanded" [code: mismatch]
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [Oslashacute, Oslash, uni1E9E, .notdef, oslash.sc, hbar.sc, germandbls.sc, oslashacute.sc, Hbar]
...
|  | fonts/encodesansexpanded/EncodeSansExpanded-Thin.ttf |
|:--- | ---:|
| Dehinted Size | 115.0kb |
| Hinted Size | 149.9kb |
| Increase | 34.8kb |
| Change   | 30.3 % |
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, DSIG, GPOS, cvt , fpgm, prep, loca, gasp]
...
* :bread: **PASS** fonts/encodesansexpanded/EncodeSansExpanded-Thin.ttf is named canonically.
