...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [germandbls.sc, Oslashacute, uni1E9E, Hbar, Oslash, .notdef, oslashacute.sc, oslash.sc, hbar.sc]
...
* :information_source: **INFO** This font contains the following optional tables [gasp, prep, GPOS, cvt , DSIG, GSUB, fpgm, loca]
