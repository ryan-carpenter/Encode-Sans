...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [oslash.sc, germandbls.sc, hbar.sc, uni1E9E, .notdef, Oslash, Hbar, oslashacute.sc, Oslashacute]
...
* :information_source: **INFO** This font contains the following optional tables [cvt , loca, GPOS, gasp, DSIG, fpgm, prep, GSUB]
