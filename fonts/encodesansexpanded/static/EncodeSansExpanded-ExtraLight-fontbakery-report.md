...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded ExtraLight' but got 'Encode Sans Expd ExLght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansExpanded-ExtraLight' but got 'EncodeSansExpd-ExLght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded ExtraLight') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd ExLght') [code: does-not]
...
|  | fonts/encodesansexpanded/static/EncodeSansExpanded-ExtraLight.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [prep, gasp, DSIG, loca, GSUB, fpgm, GPOS, cvt ]
...
* :bread: **PASS** fonts/encodesansexpanded/static/EncodeSansExpanded-ExtraLight.ttf is named canonically.
