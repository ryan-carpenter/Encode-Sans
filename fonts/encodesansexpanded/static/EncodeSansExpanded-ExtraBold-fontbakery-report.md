...
* :zzz: **SKIP** Font family at 'fonts/encodesansexpanded/static' lacks a METADATA.pb file.
...
<details>
<summary><b>[115] EncodeSansExpanded-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Expanded ExtraBold' but got 'Encode Sans Expd ExBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansExpanded-ExtraBold' but got 'EncodeSansExpd-ExBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Expanded ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Expd ExBold') [code: does-not]
...
|  | fonts/encodesansexpanded/static/EncodeSansExpanded-ExtraBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [gasp, DSIG, loca, fpgm, prep, GSUB, cvt , GPOS]
...
* :bread: **PASS** fonts/encodesansexpanded/static/EncodeSansExpanded-ExtraBold.ttf is named canonically.
