...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansSC-Thin" while METADATA.pb has "EncodeSansSC". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SC Thin" does not match post_script_name = "EncodeSansSC"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSC-VF.ttf" does not match post_script_name="EncodeSansSC".
...
* :fire: **FAIL** METADATA.pb: filename field ("EncodeSansSC-VF.ttf") does not match canonical name "EncodeSansSC-Thin.ttf".
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSC") and weight value (100). The name must be ended with "Thin" or "ThinItalic".
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1067 but it should be 1095 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [gasp, fpgm, prep, cvt , GPOS, DSIG, loca, GSUB]
...
* :bread: **PASS** Family name "Encode Sans SC" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Encode Sans SC Thin" is identical in METADATA.pb and on the TTF file.
