...
<details>
<summary><b>[118] EncodeSansCondensed-CondensedSC-VF.ttf</b></summary>
<details>
...
* :fire: **FAIL** Style name used in "fonts/encodesans_sc/full_vf/EncodeSansCondensed-CondensedSC-VF.ttf" is not canonical. You should rebuild the font using any of the following style names: "Thin", "ExtraLight", "Light", "Regular", "Medium", "SemiBold", "Bold", "ExtraBold", "Black", "Thin Italic", "ExtraLight Italic", "Light Italic", "Italic", "Medium Italic", "SemiBold Italic", "Bold Italic", "ExtraBold Italic", "Black Italic".
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SC') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans') [code: does-not]
...
|  | fonts/encodesans_sc/full_vf/EncodeSansCondensed-CondensedSC-VF.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GSUB, DSIG, GPOS, gasp, cvt , prep, loca]
