...
* :zzz: **SKIP** Font family at 'fonts/encodesanssemicondensed/static' lacks a METADATA.pb file.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed ExtraBold' but got 'Encode Sans SemiCond ExBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiCondensed-ExtraBold' but got 'EncodeSansSemiCond-ExBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiCondensed ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiCond ExBold') [code: does-not]
...
|  | fonts/encodesanssemicondensed/static/EncodeSansSemiCondensed-ExtraBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, fpgm, loca, DSIG, prep, GPOS, cvt , gasp]
...
* :bread: **PASS** fonts/encodesanssemicondensed/static/EncodeSansSemiCondensed-ExtraBold.ttf is named canonically.
