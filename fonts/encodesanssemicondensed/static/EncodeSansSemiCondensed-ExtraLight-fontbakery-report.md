...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed ExtraLight' but got 'Encode Sans SemiCond ExLght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansSemiCondensed-ExtraLight' but got 'EncodeSansSemiCond-ExLght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans SemiCondensed ExtraLight') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans SemiCond ExLght') [code: does-not]
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, fpgm, cvt , loca, DSIG, gasp, GPOS, prep]
...
* :bread: **PASS** fonts/encodesanssemicondensed/static/EncodeSansSemiCondensed-ExtraLight.ttf is named canonically.
