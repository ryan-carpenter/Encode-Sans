...
<details>
<summary><b>[118] EncodeSansSemiCondensed-ExtraLight.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiCondensed ExtraLight" while METADATA.pb has "Encode Sans SemiCondensed" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansSemiCond-XLght" while METADATA.pb has "EncodeSansSemiCond-ExLght". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiCond XLght" while METADATA.pb has "Encode Sans SemiCondensed ExtraLight". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiCondensed ExtraLight" does not match post_script_name = "EncodeSansSemiCond-ExLght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiCondensed-ExtraLight.ttf" does not match post_script_name="EncodeSansSemiCond-ExLght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCond-ExLght") does not match correct font name format ("Encode Sans SemiCondensed ExtraLight").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed ExtraLight") does not match name table entry "Encode Sans SemiCond XLght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiCond-ExLght") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, loca, prep, GSUB, DSIG, gasp, cvt , fpgm]
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiCondensed' in 'Encode Sans SemiCondensed ExtraLight')
