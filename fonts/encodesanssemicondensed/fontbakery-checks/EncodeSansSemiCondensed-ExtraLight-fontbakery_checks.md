...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Condensed ExtraLight" while METADATA.pb has "Encode Sans SemiCondensed" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Cond XLght" while METADATA.pb has "Encode Sans SemiCondensed ExtraLight". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiCondensed ExtraLight") does not match correct font name format ("Encode Sans Semi Condensed").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCond-ExLght") does not match correct font name format ("Encode Sans Semi Condensed ExtraLight").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed ExtraLight") does not match name table entry "Encode Sans Semi Cond XLght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed ExtraLight' but got 'Encode Sans Semi Cond XLght'.
...
* :information_source: **INFO** This font contains the following optional tables [prep, fpgm, gasp, GPOS, DSIG, loca, cvt , GSUB]
