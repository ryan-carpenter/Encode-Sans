...
<details>
<summary><b>[118] EncodeSansSemiCondensed-Medium.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Condensed Medium" while METADATA.pb has "Encode Sans SemiCondensed" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Cond Med" while METADATA.pb has "Encode Sans SemiCondensed Medium". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiCondensed Medium" does not match post_script_name = "EncodeSansSemiCond-Med"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiCondensed-Medium.ttf" does not match post_script_name="EncodeSansSemiCond-Med".
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiCondensed Medium") does not match correct font name format ("Encode Sans Semi Condensed").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCond-Med") does not match correct font name format ("Encode Sans Semi Condensed Medium").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed Medium") does not match name table entry "Encode Sans Semi Cond Med" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiCond-Med") and weight value (500). The name must be ended with "Medium" or "MediumItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed Medium' but got 'Encode Sans Semi Cond Med'.
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, loca, gasp, cvt , prep, GPOS, fpgm, GSUB]
...
* :bread: **PASS** Postscript name "EncodeSansSemiCond-Med" is identical in METADATA.pb and on the TTF file.
