...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiCondensed Medium" while METADATA.pb has "Encode Sans SemiCondensed" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiCond Med" while METADATA.pb has "Encode Sans SemiCondensed Medium". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCond-Med") does not match correct font name format ("Encode Sans SemiCondensed Medium").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed Medium") does not match name table entry "Encode Sans SemiCond Med" ! [code: fullname-mismatch]
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiCondensed' in 'Encode Sans SemiCondensed Medium')
