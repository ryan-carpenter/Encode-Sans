...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Condensed Light" while METADATA.pb has "Encode Sans SemiCondensed" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Cond Lght" while METADATA.pb has "Encode Sans SemiCondensed Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiCondensed Light") does not match correct font name format ("Encode Sans Semi Condensed").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCond-Lght") does not match correct font name format ("Encode Sans Semi Condensed Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed Light") does not match name table entry "Encode Sans Semi Cond Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed Light' but got 'Encode Sans Semi Cond Lght'.
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GPOS, cvt , GSUB, loca, DSIG, gasp, prep]
