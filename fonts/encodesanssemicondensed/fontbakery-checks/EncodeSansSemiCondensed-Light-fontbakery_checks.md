...
<details>
<summary><b>[118] EncodeSansSemiCondensed-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiCondensed Light" while METADATA.pb has "Encode Sans SemiCondensed" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiCond Lght" while METADATA.pb has "Encode Sans SemiCondensed Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiCondensed Light" does not match post_script_name = "EncodeSansSemiCond-Lght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiCondensed-Light.ttf" does not match post_script_name="EncodeSansSemiCond-Lght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCond-Lght") does not match correct font name format ("Encode Sans SemiCondensed Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed Light") does not match name table entry "Encode Sans SemiCond Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiCond-Lght") and weight value (300). The name must be ended with "Light" or "LightItalic".
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, fpgm, DSIG, GSUB, prep, gasp, loca, cvt ]
...
* :bread: **PASS** Postscript name "EncodeSansSemiCond-Lght" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiCondensed' in 'Encode Sans SemiCondensed Light')
