...
<details>
<summary><b>[118] EncodeSansSemiCondensed-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans SemiCondensed ExtraBold" while METADATA.pb has "Encode Sans SemiCondensed" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansSemiCond-XBold" while METADATA.pb has "EncodeSansSemiCond-ExBold". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SemiCond XBold" while METADATA.pb has "Encode Sans SemiCondensed ExtraBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SemiCondensed ExtraBold" does not match post_script_name = "EncodeSansSemiCond-ExBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansSemiCondensed-ExtraBold.ttf" does not match post_script_name="EncodeSansSemiCond-ExBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCond-ExBold") does not match correct font name format ("Encode Sans SemiCondensed ExtraBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed ExtraBold") does not match name table entry "Encode Sans SemiCond XBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansSemiCond-ExBold") and weight value (800). The name must be ended with "ExtraBold" or "ExtraBoldItalic".
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, DSIG, loca, GSUB, gasp, cvt , fpgm, prep]
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans SemiCondensed' in 'Encode Sans SemiCondensed ExtraBold')
