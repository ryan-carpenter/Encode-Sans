...
<details>
<summary><b>[117] EncodeSansCondensedSC-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansCondSC-XBold" while METADATA.pb has "EncodeSansCondSC-ExBold". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Cond SC XBold" while METADATA.pb has "Encode Sans Condensed SC ExtraBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Condensed SC ExtraBold" does not match post_script_name = "EncodeSansCondSC-ExBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansCondensedSC-ExtraBold.ttf" does not match post_script_name="EncodeSansCondSC-ExBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansCondSC-ExBold") does not match correct font name format ("Encode Sans Condensed SC ExtraBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Condensed SC ExtraBold") does not match name table entry "Encode Sans Cond SC XBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansCondSC-ExBold") and weight value (800). The name must be ended with "ExtraBold" or "ExtraBoldItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed SC ExtraBold' but got 'Encode Sans Cond SC XBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensedSC-ExtraBold' but got 'EncodeSansCondSC-XBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed SC ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond SC XBold') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1087 but it should be 1118 which corresponds to the average of the widths of all glyphs in the font.
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Condensed SC ExtraBold' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanscondensedsc/EncodeSansCondensedSC-ExtraBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, fpgm, cvt , DSIG, loca, GSUB, gasp, prep]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans Condensed SC ExtraBold | exceeds max length (31) |
...
* :bread: **PASS** fonts/encodesanscondensedsc/EncodeSansCondensedSC-ExtraBold.ttf is named canonically.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Condensed SC' in 'Encode Sans Condensed SC ExtraBold')
