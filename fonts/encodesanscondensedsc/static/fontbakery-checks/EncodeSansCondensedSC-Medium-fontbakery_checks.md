...
<details>
<summary><b>[117] EncodeSansCondensedSC-Medium.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Cond SC Med" while METADATA.pb has "Encode Sans Condensed SC Medium". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Condensed SC Medium" does not match post_script_name = "EncodeSansCondSC-Med"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansCondensedSC-Medium.ttf" does not match post_script_name="EncodeSansCondSC-Med".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansCondSC-Med") does not match correct font name format ("Encode Sans Condensed SC Medium").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Condensed SC Medium") does not match name table entry "Encode Sans Cond SC Med" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansCondSC-Med") and weight value (500). The name must be ended with "Medium" or "MediumItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed SC Medium' but got 'Encode Sans Cond SC Med'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensedSC-Medium' but got 'EncodeSansCondSC-Med'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed SC Medium') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond SC Med') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1004 but it should be 1034 which corresponds to the average of the widths of all glyphs in the font.
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Condensed SC Medium' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanscondensedsc/EncodeSansCondensedSC-Medium.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [loca, GPOS, GSUB, fpgm, gasp, cvt , prep, DSIG]
...
* :bread: **PASS** fonts/encodesanscondensedsc/EncodeSansCondensedSC-Medium.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansCondSC-Med" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Condensed SC' in 'Encode Sans Condensed SC Medium')
