...
<details>
<summary><b>[117] EncodeSansCondensedSC-Regular.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Cond SC Reg" while METADATA.pb has "Encode Sans Condensed SC Regular". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Condensed SC Regular" does not match post_script_name = "EncodeSansCondSC-Reg"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansCondensedSC-Regular.ttf" does not match post_script_name="EncodeSansCondSC-Reg".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansCondSC-Reg") does not match correct font name format ("Encode Sans Condensed SC").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Condensed SC Regular") does not match name table entry "Encode Sans Cond SC Reg" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansCondSC-Reg") and weight value (400). The name must be ended with "Regular" or "Italic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed SC Regular' but got 'Encode Sans Cond SC Reg'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensedSC-Regular' but got 'EncodeSansCondSC-Reg'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed SC') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond SC Reg') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 981 but it should be 1010 which corresponds to the average of the widths of all glyphs in the font.
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Condensed SC' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanscondensedsc/EncodeSansCondensedSC-Regular.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, loca, prep, cvt , GSUB, fpgm, gasp, DSIG]
...
* :bread: **PASS** fonts/encodesanscondensedsc/EncodeSansCondensedSC-Regular.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansCondSC-Reg" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Condensed SC' in 'Encode Sans Condensed SC Regular')
