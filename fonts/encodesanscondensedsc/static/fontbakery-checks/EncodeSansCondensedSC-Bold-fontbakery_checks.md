...
<details>
<summary><b>[117] EncodeSansCondensedSC-Bold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Cond SC Bold" while METADATA.pb has "Encode Sans Condensed SC Bold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Condensed SC Bold" does not match post_script_name = "EncodeSansCondSC-Bold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansCondensedSC-Bold.ttf" does not match post_script_name="EncodeSansCondSC-Bold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansCondSC-Bold") does not match correct font name format ("Encode Sans Condensed SC").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Condensed SC Bold") does not match name table entry "Encode Sans Cond SC Bold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed SC Bold' but got 'Encode Sans Cond SC Bold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensedSC-Bold' but got 'EncodeSansCondSC-Bold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed SC') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond SC Bold') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1057 but it should be 1088 which corresponds to the average of the widths of all glyphs in the font.
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Condensed SC' / SUBFAMILY_NAME = 'Bold'
...
|  | fonts/encodesanscondensedsc/EncodeSansCondensedSC-Bold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, GPOS, cvt , fpgm, gasp, prep, DSIG, loca]
...
* :bread: **PASS** fonts/encodesanscondensedsc/EncodeSansCondensedSC-Bold.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansCondSC-Bold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Condensed SC' in 'Encode Sans Condensed SC Bold')
