...
<details>
<summary><b>[116] EncodeSansCondensedSC-Thin.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched familyname in font: TTF has "Encode Sans Condensed SC" while METADATA.pb has name="Encode Sans SC Condensed". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.name field ("Encode Sans SC Condensed") does not match correct font name format ("Encode Sans Condensed SC").
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SC Condensed Thin") does not match correct font name format ("Encode Sans Condensed SC").
...
* :information_source: **INFO** This font contains the following optional tables [gasp, GSUB, fpgm, cvt , DSIG, prep, GPOS, loca]
