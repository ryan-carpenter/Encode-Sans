...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Condensed SC" while METADATA.pb has "Encode Sans SC Condensed" [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans SC Condensed Thin" does not match post_script_name = "EncodeSansCondSC-Thin"
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansCondSC-Thin") does not match correct font name format ("Encode Sans Condensed SC").
...
* :fire: **FAIL** METADATA.pb: filename field ("EncodeSansCondensedSC-Thin.ttf") does not match canonical name "EncodeSansSCCondensed-Thin.ttf".
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed SC Thin' but got 'Encode Sans Condensed SC'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed SC') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond SC Thin') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Condensed SC' / SUBFAMILY_NAME = 'Thin'
...
* :information_source: **INFO** This font contains the following optional tables [cvt , fpgm, loca, GPOS, gasp, DSIG, prep, GSUB]
