...
<details>
<summary><b>[117] EncodeSansCondensedSC-SemiBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Cond SC SemiBold" while METADATA.pb has "Encode Sans Condensed SC SemiBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Condensed SC SemiBold" does not match post_script_name = "EncodeSansCondSC-SemiBold"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansCondensedSC-SemiBold.ttf" does not match post_script_name="EncodeSansCondSC-SemiBold".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansCondSC-SemiBold") does not match correct font name format ("Encode Sans Condensed SC SemiBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Condensed SC SemiBold") does not match name table entry "Encode Sans Cond SC SemiBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed SC SemiBold' but got 'Encode Sans Cond SC SemiBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensedSC-SemiBold' but got 'EncodeSansCondSC-SemiBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed SC SemiBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond SC SemiBold') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1030 but it should be 1060 which corresponds to the average of the widths of all glyphs in the font.
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Condensed SC SemiBold' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanscondensedsc/EncodeSansCondensedSC-SemiBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, gasp, GSUB, GPOS, prep, cvt , loca, DSIG]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans Condensed SC SemiBold | exceeds max length (31) |
...
* :bread: **PASS** fonts/encodesanscondensedsc/EncodeSansCondensedSC-SemiBold.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansCondSC-SemiBold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Condensed SC' in 'Encode Sans Condensed SC SemiBold')
