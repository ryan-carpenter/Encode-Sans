...
<details>
<summary><b>[118] EncodeSansCondensedSC-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Condensed SC ExtraBold" while METADATA.pb has "Encode Sans Condensed SC" [code: mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1087 but it should be 1118 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, fpgm, GSUB, prep, loca, cvt , gasp, DSIG]
