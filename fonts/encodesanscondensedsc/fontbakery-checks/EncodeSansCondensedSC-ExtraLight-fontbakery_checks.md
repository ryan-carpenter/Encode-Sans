...
* :bread: **PASS** fonts/encodesanscondensedsc/DESCRIPTION.en_us.html is a propper HTML file.
...
<details>
<summary><b>[117] EncodeSansCondensedSC-ExtraLight.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansCondSC-XLght" while METADATA.pb has "EncodeSansCondSC-ExLght". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Cond SC XLght" while METADATA.pb has "Encode Sans Condensed SC ExtraLight". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Condensed SC ExtraLight" does not match post_script_name = "EncodeSansCondSC-ExLght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansCondensedSC-ExtraLight.ttf" does not match post_script_name="EncodeSansCondSC-ExLght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansCondSC-ExLght") does not match correct font name format ("Encode Sans Condensed SC ExtraLight").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Condensed SC ExtraLight") does not match name table entry "Encode Sans Cond SC XLght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansCondSC-ExLght") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed SC ExtraLight' but got 'Encode Sans Cond SC XLght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensedSC-ExtraLight' but got 'EncodeSansCondSC-XLght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed SC ExtraLight') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond SC XLght') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 947 but it should be 975 which corresponds to the average of the widths of all glyphs in the font.
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Condensed SC ExtraLight' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanscondensedsc/EncodeSansCondensedSC-ExtraLight.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, prep, GSUB, loca, fpgm, gasp, GPOS, cvt ]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans Condensed SC ExtraLight | exceeds max length (31) |
...
* :bread: **PASS** fonts/encodesanscondensedsc/EncodeSansCondensedSC-ExtraLight.ttf is named canonically.
...
* :bread: **PASS** Family name "Encode Sans Condensed SC" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** OK: Family name "Encode Sans Condensed SC" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Condensed SC' in 'Encode Sans Condensed SC ExtraLight')
