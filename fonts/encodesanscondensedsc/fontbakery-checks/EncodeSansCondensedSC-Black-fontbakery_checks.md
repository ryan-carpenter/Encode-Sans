...
<details>
<summary><b>[118] EncodeSansCondensedSC-Black.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Condensed SC Black" while METADATA.pb has "Encode Sans Condensed SC" [code: mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1118 but it should be 1149 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, fpgm, DSIG, prep, GPOS, cvt , loca, gasp]
