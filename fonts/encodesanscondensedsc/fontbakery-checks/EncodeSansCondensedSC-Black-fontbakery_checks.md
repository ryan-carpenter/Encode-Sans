...
|  | fonts/encodesanscondensed_sc/EncodeSansCondensedSC-Black.ttf |
|:--- | ---:|
| Dehinted Size | 79.4kb |
| Hinted Size | 109.0kb |
| Increase | 29.6kb |
| Change   | 37.2 % |
...
* :information_source: **INFO** This font contains the following optional tables [loca, gasp, GPOS, GSUB, fpgm, DSIG, prep, cvt ]
...
* :bread: **PASS** fonts/encodesanscondensed_sc/EncodeSansCondensedSC-Black.ttf is named canonically.
