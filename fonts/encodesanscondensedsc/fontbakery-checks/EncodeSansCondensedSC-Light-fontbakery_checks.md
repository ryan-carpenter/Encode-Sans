...
<details>
<summary><b>[118] EncodeSansCondensedSC-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Condensed SC Light" while METADATA.pb has "Encode Sans Condensed SC" [code: mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 961 but it should be 990 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [loca, GPOS, DSIG, fpgm, cvt , gasp, prep, GSUB]
