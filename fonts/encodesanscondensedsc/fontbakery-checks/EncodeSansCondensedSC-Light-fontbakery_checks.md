...
<details>
<summary><b>[117] EncodeSansCondensedSC-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Cond SC Lght" while METADATA.pb has "Encode Sans Condensed SC Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Condensed SC Light" does not match post_script_name = "EncodeSansCondSC-Lght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansCondensedSC-Light.ttf" does not match post_script_name="EncodeSansCondSC-Lght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansCondSC-Lght") does not match correct font name format ("Encode Sans Condensed SC Light").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Condensed SC Light") does not match name table entry "Encode Sans Cond SC Lght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansCondSC-Lght") and weight value (300). The name must be ended with "Light" or "LightItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed SC Light' but got 'Encode Sans Cond SC Lght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensedSC-Light' but got 'EncodeSansCondSC-Lght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed SC Light') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond SC Lght') [code: does-not]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 961 but it should be 990 which corresponds to the average of the widths of all glyphs in the font.
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Condensed SC Light' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanscondensedsc/EncodeSansCondensedSC-Light.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [prep, GSUB, fpgm, gasp, cvt , loca, DSIG, GPOS]
...
* :bread: **PASS** fonts/encodesanscondensedsc/EncodeSansCondensedSC-Light.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansCondSC-Lght" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Condensed SC' in 'Encode Sans Condensed SC Light')
