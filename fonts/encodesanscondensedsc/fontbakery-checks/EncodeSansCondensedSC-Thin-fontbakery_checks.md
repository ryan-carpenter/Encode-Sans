...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Cond SC Thin" while METADATA.pb has "Encode Sans Condensed SC Thin". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Condensed SC Thin" does not match post_script_name = "EncodeSansCondSC-Thin"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansCondensedSC-Thin.ttf" does not match post_script_name="EncodeSansCondSC-Thin".
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Condensed SC Thin") does not match name table entry "Encode Sans Cond SC Thin" ! [code: fullname-mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 936 but it should be 965 which corresponds to the average of the widths of all glyphs in the font.
...
|  | fonts/encodesanscondensedsc/EncodeSansCondensedSC-Thin.ttf |
|:--- | ---:|
| Dehinted Size | 88.1kb |
| Hinted Size | 117.5kb |
| Increase | 29.4kb |
| Change   | 33.3 % |
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, prep, fpgm, loca, gasp, cvt , GSUB, DSIG]
...
* :bread: **PASS** fonts/encodesanscondensedsc/EncodeSansCondensedSC-Thin.ttf is named canonically.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Condensed SC' in 'Encode Sans Condensed SC Thin')
