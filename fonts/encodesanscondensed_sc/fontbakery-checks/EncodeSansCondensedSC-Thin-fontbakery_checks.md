...
|  | fonts/encodesanscondensed_sc/EncodeSansCondensedSC-Thin.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, DSIG, gasp, fpgm, cvt , GSUB, prep, loca]
...
* :bread: **PASS** fonts/encodesanscondensed_sc/EncodeSansCondensedSC-Thin.ttf is named canonically.
