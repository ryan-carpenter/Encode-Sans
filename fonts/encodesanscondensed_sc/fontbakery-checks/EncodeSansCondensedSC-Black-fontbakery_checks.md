...
* :warning: **WARN** OS/2 xAvgCharWidth is 1119 but it should be 1151 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [loca, GPOS, GSUB, prep, cvt , DSIG, fpgm, gasp]
