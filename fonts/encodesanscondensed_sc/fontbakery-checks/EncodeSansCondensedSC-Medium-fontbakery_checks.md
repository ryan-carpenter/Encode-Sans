...
|  | fonts/encodesanscondensed_sc/EncodeSansCondensedSC-Medium.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GPOS, gasp, cvt , loca, GSUB, prep, DSIG]
...
* :bread: **PASS** fonts/encodesanscondensed_sc/EncodeSansCondensedSC-Medium.ttf is named canonically.
