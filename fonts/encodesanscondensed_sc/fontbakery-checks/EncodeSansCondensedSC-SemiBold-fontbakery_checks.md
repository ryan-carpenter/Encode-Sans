...
* :warning: **WARN** OS/2 xAvgCharWidth is 1029 but it should be 1059 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [prep, gasp, DSIG, GSUB, cvt , fpgm, GPOS, loca]
