...
|  | fonts/encodesanscondensed_sc/EncodeSansCondensedSC-SemiBold.ttf |
|:--- | ---:|
| Dehinted Size | 79.5kb |
| Hinted Size | 110.1kb |
| Increase | 30.6kb |
| Change   | 38.6 % |
...
* :information_source: **INFO** This font contains the following optional tables [prep, gasp, GSUB, cvt , fpgm, loca, GPOS, DSIG]
...
* :bread: **PASS** fonts/encodesanscondensed_sc/EncodeSansCondensedSC-SemiBold.ttf is named canonically.
