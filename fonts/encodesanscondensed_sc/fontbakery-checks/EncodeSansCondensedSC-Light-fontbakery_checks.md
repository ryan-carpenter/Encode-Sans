...
|  | fonts/encodesanscondensed_sc/EncodeSansCondensedSC-Light.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GPOS, cvt , DSIG, prep, gasp, GSUB, loca]
...
* :bread: **PASS** fonts/encodesanscondensed_sc/EncodeSansCondensedSC-Light.ttf is named canonically.
