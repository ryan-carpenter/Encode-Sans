...
|  | fonts/encodesanscondensed_sc/EncodeSansCondensedSC-Regular.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, DSIG, cvt , GPOS, gasp, loca, prep, GSUB]
...
* :bread: **PASS** fonts/encodesanscondensed_sc/EncodeSansCondensedSC-Regular.ttf is named canonically.
