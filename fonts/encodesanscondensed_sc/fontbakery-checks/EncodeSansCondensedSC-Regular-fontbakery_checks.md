...
* :warning: **WARN** OS/2 xAvgCharWidth is 978 but it should be 1007 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, loca, gasp, prep, cvt , fpgm, GSUB, DSIG]
