...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Cond Bold" while METADATA.pb has "Encode Sans SemiCondensed SC Bold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiCondensed SC Bold") does not match correct font name format ("Encode Sans Semi Condensed").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCondSC-Bold") does not match correct font name format ("Encode Sans Semi Condensed").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed SC Bold") does not match name table entry "Encode Sans Semi Cond Bold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed SC Bold' but got 'Encode Sans Semi Cond Bold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Semi Condensed') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Semi Cond Bold') [code: does-not]
...
* :information_source: **INFO** This font contains the following optional tables [loca, DSIG, GPOS, cvt , prep, GSUB, gasp, fpgm]
