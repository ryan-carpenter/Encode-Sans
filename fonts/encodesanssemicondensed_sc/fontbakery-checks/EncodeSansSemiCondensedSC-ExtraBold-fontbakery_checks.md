...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Semi Condensed ExtraBold" while METADATA.pb has "Encode Sans SemiCondensed SC" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Semi Cond XBold" while METADATA.pb has "Encode Sans SemiCondensed SC ExtraBold". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font.full_name field ("Encode Sans SemiCondensed SC ExtraBold") does not match correct font name format ("Encode Sans Semi Condensed").
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansSemiCondSC-ExBold") does not match correct font name format ("Encode Sans Semi Condensed ExtraBold").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SemiCondensed SC ExtraBold") does not match name table entry "Encode Sans Semi Cond XBold" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed SC ExtraBold' but got 'Encode Sans Semi Condensed ExtraBold'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Semi Condensed SC ExtraBold' but got 'Encode Sans Semi Cond XBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Semi Condensed ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Semi Cond XBold') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Semi Condensed ExtraBold' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** This font contains the following optional tables [loca, GSUB, gasp, DSIG, fpgm, prep, GPOS, cvt ]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans Semi Condensed ExtraBold | exceeds max length (31) |
