...
* :warning: **WARN** OS/2 xAvgCharWidth is 1164 but it should be 1195 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, GSUB, fpgm, cvt , prep, gasp, GPOS, loca]
