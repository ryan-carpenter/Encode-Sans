...
* :warning: **WARN** OS/2 xAvgCharWidth is 1047 but it should be 1077 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
|  | fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-Regular.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, cvt , prep, gasp, GSUB, fpgm, DSIG, loca]
...
* :bread: **PASS** fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-Regular.ttf is named canonically.
