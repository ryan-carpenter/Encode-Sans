...
* :warning: **WARN** OS/2 xAvgCharWidth is 1025 but it should be 1055 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [prep, gasp, loca, fpgm, cvt , DSIG, GSUB, GPOS]
