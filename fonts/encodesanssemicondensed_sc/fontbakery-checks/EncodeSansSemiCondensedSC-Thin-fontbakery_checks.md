...
|  | fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-Thin.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [prep, DSIG, GPOS, GSUB, gasp, fpgm, loca, cvt ]
...
* :bread: **PASS** fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-Thin.ttf is named canonically.
