...
* :warning: **WARN** OS/2 xAvgCharWidth is 1102 but it should be 1132 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [gasp, cvt , prep, loca, GSUB, DSIG, GPOS, fpgm]
