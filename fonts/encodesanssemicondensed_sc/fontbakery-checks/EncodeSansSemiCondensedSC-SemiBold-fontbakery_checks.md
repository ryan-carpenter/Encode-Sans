...
|  | fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-SemiBold.ttf |
|:--- | ---:|
| Dehinted Size | 79.7kb |
| Hinted Size | 109.3kb |
| Increase | 29.7kb |
| Change   | 37.2 % |
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, GSUB, prep, fpgm, GPOS, gasp, loca, cvt ]
...
* :bread: **PASS** fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-SemiBold.ttf is named canonically.
