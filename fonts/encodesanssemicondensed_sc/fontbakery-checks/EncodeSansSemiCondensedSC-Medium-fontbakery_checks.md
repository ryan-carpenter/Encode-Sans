...
|  | fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-Medium.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [loca, gasp, cvt , prep, DSIG, GPOS, fpgm, GSUB]
...
* :bread: **PASS** fonts/encodesanssemicondensed_sc/EncodeSansSemiCondensedSC-Medium.ttf is named canonically.
