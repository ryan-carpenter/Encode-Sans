...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans SC" while METADATA.pb has "Encode Sans SC Thin". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans SC Thin") does not match name table entry "Encode Sans SC" ! [code: fullname-mismatch]
...
* :bread: **PASS** Postscript name "EncodeSansSC" is identical in METADATA.pb and on the TTF file.
