...
<details>
<summary><b>[118] EncodeSansnormalSC-VF.ttf</b></summary>
<details>
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans normal SC' / SUBFAMILY_NAME = 'Thin'
...
|  | fonts/encodesans_sc/EncodeSansnormalSC-VF.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GPOS, loca, GSUB, prep, cvt , DSIG, gasp]
...
* :bread: **PASS** fonts/encodesans_sc/EncodeSansnormalSC-VF.ttf is named canonically.
