...
* :warning: **WARN** OS/2 xAvgCharWidth is 1358 but it should be 1386 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, gasp, GSUB, fpgm, prep, loca, GPOS, cvt ]
