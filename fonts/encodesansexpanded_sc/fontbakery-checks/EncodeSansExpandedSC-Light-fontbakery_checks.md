...
* :warning: **WARN** OS/2 xAvgCharWidth is 1231 but it should be 1259 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [cvt , GSUB, prep, GPOS, fpgm, DSIG, gasp, loca]
