...
* :warning: **WARN** OS/2 xAvgCharWidth is 1437 but it should be 1465 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [gasp, prep, cvt , loca, GSUB, fpgm, GPOS, DSIG]
