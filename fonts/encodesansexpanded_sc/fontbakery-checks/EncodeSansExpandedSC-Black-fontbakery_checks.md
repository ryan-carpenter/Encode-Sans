...
|  | fonts/encodesansexpanded_sc/EncodeSansExpandedSC-Black.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, prep, cvt , gasp, GSUB, loca, GPOS, fpgm]
...
* :bread: **PASS** fonts/encodesansexpanded_sc/EncodeSansExpandedSC-Black.ttf is named canonically.
