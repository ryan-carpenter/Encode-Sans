...
* :warning: **WARN** OS/2 xAvgCharWidth is 1288 but it should be 1316 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, prep, GPOS, loca, fpgm, gasp, cvt , DSIG]
