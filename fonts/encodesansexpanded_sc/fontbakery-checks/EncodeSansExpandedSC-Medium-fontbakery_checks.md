...
|  | fonts/encodesansexpanded_sc/EncodeSansExpandedSC-Medium.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [prep, GSUB, loca, DSIG, GPOS, fpgm, cvt , gasp]
...
* :bread: **PASS** fonts/encodesansexpanded_sc/EncodeSansExpandedSC-Medium.ttf is named canonically.
