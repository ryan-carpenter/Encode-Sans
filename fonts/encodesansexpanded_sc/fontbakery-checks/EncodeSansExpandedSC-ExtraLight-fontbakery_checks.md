...
* :bread: **PASS** fonts/encodesansexpanded_sc/DESCRIPTION.en_us.html is a propper HTML file.
...
|  | fonts/encodesansexpanded_sc/EncodeSansExpandedSC-ExtraLight.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, cvt , GPOS, prep, loca, GSUB, gasp, DSIG]
...
* :bread: **PASS** fonts/encodesansexpanded_sc/EncodeSansExpandedSC-ExtraLight.ttf is named canonically.
