...
|  | fonts/encodesansexpanded_sc/EncodeSansExpandedSC-ExtraBold.ttf |
|:--- | ---:|
| Dehinted Size | 80.6kb |
| Hinted Size | 112.6kb |
| Increase | 31.9kb |
| Change   | 39.6 % |
...
* :information_source: **INFO** This font contains the following optional tables [prep, GSUB, gasp, cvt , loca, fpgm, GPOS, DSIG]
...
* :bread: **PASS** fonts/encodesansexpanded_sc/EncodeSansExpandedSC-ExtraBold.ttf is named canonically.
