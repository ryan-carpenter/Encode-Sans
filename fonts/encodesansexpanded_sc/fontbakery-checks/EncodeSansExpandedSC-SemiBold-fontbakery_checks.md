...
|  | fonts/encodesansexpanded_sc/EncodeSansExpandedSC-SemiBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [prep, fpgm, cvt , gasp, DSIG, loca, GSUB, GPOS]
...
* :bread: **PASS** fonts/encodesansexpanded_sc/EncodeSansExpandedSC-SemiBold.ttf is named canonically.
