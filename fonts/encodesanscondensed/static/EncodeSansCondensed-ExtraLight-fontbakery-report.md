...
* :zzz: **SKIP** Font family at 'fonts/encodesanscondensed/static' lacks a METADATA.pb file.
...
<details>
<summary><b>[115] EncodeSansCondensed-ExtraLight.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed ExtraLight' but got 'Encode Sans Cond ExLght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensed-ExtraLight' but got 'EncodeSansCond-ExLght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed ExtraLight') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond ExLght') [code: does-not]
...
|  | fonts/encodesanscondensed/static/EncodeSansCondensed-ExtraLight.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [loca, cvt , gasp, prep, GSUB, DSIG, GPOS, fpgm]
...
* :bread: **PASS** fonts/encodesanscondensed/static/EncodeSansCondensed-ExtraLight.ttf is named canonically.
