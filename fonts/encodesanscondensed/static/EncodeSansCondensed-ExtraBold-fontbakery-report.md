...
<details>
<summary><b>[115] EncodeSansCondensed-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed ExtraBold' but got 'Encode Sans Cond ExBold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensed-ExtraBold' but got 'EncodeSansCond-ExBold'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed ExtraBold') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond ExBold') [code: does-not]
...
|  | fonts/encodesanscondensed/static/EncodeSansCondensed-ExtraBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, DSIG, loca, GPOS, cvt , prep, GSUB, gasp]
...
* :bread: **PASS** fonts/encodesanscondensed/static/EncodeSansCondensed-ExtraBold.ttf is named canonically.
