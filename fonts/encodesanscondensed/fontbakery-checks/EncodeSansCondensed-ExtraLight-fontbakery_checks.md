...
<details>
<summary><b>[118] EncodeSansCondensed-ExtraLight.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Condensed ExtraLight" while METADATA.pb has "Encode Sans Condensed" [code: mismatch]
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "EncodeSansCond-XLght" while METADATA.pb has "EncodeSansCond-ExLght". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Cond XLght" while METADATA.pb has "Encode Sans Condensed ExtraLight". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Condensed ExtraLight" does not match post_script_name = "EncodeSansCond-ExLght"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansCondensed-ExtraLight.ttf" does not match post_script_name="EncodeSansCond-ExLght".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansCond-ExLght") does not match correct font name format ("Encode Sans Condensed ExtraLight").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Condensed ExtraLight") does not match name table entry "Encode Sans Cond XLght" ! [code: fullname-mismatch]
...
* :fire: **FAIL** METADATA.pb: Mismatch between postScriptName ("EncodeSansCond-ExLght") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed ExtraLight' but got 'Encode Sans Cond XLght'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensed-ExtraLight' but got 'EncodeSansCond-XLght'.
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Encode Sans Condensed ExtraLight') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Encode Sans Cond XLght') [code: does-not]
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [uni1E4E, Ecaron, oslash, uni1E78, uni01C6, Edotaccent, uni1EBC, uni01C4, Ubreve, H, Eacute, uni0216, uni01F1, wacute.sc, Umacron, f_l, Ugrave, uni01C5, OE, Edieresis, uni1EF0, Hcircumflex, uni1E16, fl, uni01CC.sc, oslash.sc, Eng, w.sc, lira.tf, AEacute, uni1E9E, W, uni01F3.sc, uni0206, Q, product, wdieresis, uni1ED6, uni1EE0, uni01C6.sc, germandbls.sc, Ntilde, uni1E44, uni20A6, uni1EC4, uni0204, Wgrave, uni20BF.tf, .notdef, M, Uhorn, Uhungarumlaut, Egrave, uni1EB8, Iacute_J.loclNLD, Oslash, Nacute, uni20BF, Ncaron, uni1EE4, Utilde, uni0214, uni1EBE, AE, uni1E79.sc, uni1E42, product.tf, uni1EEF.sc, Ebreve, uni022C, Wacute, at, U, wcircumflex.sc, N, wgrave.sc, uni01F2, peseta, Wdieresis, uni1E7A, Uacute, uni1EEE, Udieresis, D, oslashacute, uni1EEC, uni1EC0, uni1EE8, lira, perthousand, uni1E46, K, I_J.loclNLD, uni2116, oslashacute.sc, f_j, wdieresis.sc, Oslashacute, pi, uni1E0C, Dcaron, uni1E24, uni01CB, uni1EC6, Ucircumflex, uni01C8, uni1EC2, uni1EBA, uni1E14, uni1EDE, Uogonek, Wcircumflex, uni01CA, uni1EEA, uni1EE6, uni1E48, Uring, uni1E2A, uni01C7, uni1E0E, dong.tf, uni20A9, Ecircumflex, uni1E4C]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Condensed ExtraLight' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/encodesanscondensed/EncodeSansCondensed-ExtraLight.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [cvt , loca, DSIG, GPOS, fpgm, gasp, GSUB, prep]
...
|:----- |:----- |:-------------- |
| Family Name | Encode Sans Condensed ExtraLight | exceeds max length (31) |
...
* :bread: **PASS** fonts/encodesanscondensed/EncodeSansCondensed-ExtraLight.ttf is named canonically.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Condensed' in 'Encode Sans Condensed ExtraLight')
