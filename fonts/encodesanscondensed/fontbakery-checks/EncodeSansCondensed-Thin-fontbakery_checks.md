...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [hbar.sc, Oslash, Oslashacute, germandbls.sc, oslash.sc, Hbar, .notdef, uni1E9E, oslashacute.sc]
...
* :information_source: **INFO** This font contains the following optional tables [cvt , DSIG, fpgm, prep, loca, GSUB, gasp, GPOS]
