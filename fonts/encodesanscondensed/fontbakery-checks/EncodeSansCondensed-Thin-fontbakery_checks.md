...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [Oslashacute, uni1E9E, oslashacute.sc, oslash.sc, Hbar, Oslash, .notdef, germandbls.sc, hbar.sc]
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, prep, fpgm, loca, GSUB, cvt , DSIG, gasp]
