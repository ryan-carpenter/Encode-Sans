...
<details>
<summary><b>[118] EncodeSansCondensed-Black.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched family name in font: TTF has "Encode Sans Condensed Black" while METADATA.pb has "Encode Sans Condensed" [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Encode Sans Cond Black" while METADATA.pb has "Encode Sans Condensed Black". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font full_name="Encode Sans Condensed Black" does not match post_script_name = "EncodeSansCond-Black"
...
* :fire: **FAIL** METADATA.pb font filename="EncodeSansCondensed-Black.ttf" does not match post_script_name="EncodeSansCond-Black".
...
* :fire: **FAIL** METADATA.pb postScriptName ("EncodeSansCond-Black") does not match correct font name format ("Encode Sans Condensed Black").
...
* :fire: **FAIL** METADATA.pb: Fullname ("Encode Sans Condensed Black") does not match name table entry "Encode Sans Cond Black" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Encode Sans Condensed Black' but got 'Encode Sans Cond Black'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'EncodeSansCondensed-Black' but got 'EncodeSansCond-Black'.
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [Aogonek, oslashacute, oslashacute.sc, .notdef, Iogonek, lslash.sc, germandbls.sc, Oslashacute, lslash, Oslash, iogonek, Lslash, uni1E9E, Hbar, scedilla, scedilla.sc, Dcroat, hbar, Tbar, oslash, tbar, Scedilla, dcroat, Eth, aogonek.sc, iogonek.sc, dcroat.sc, eth.sc, tbar.sc, hbar.sc, oslash.sc, Eogonek, eogonek.sc]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Encode Sans Condensed Black' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** This font contains the following optional tables [prep, GPOS, cvt , fpgm, GSUB, DSIG, loca, gasp]
...
* :bread: **PASS** fonts/encodesanscondensed/EncodeSansCondensed-Black.ttf is named canonically.
...
* :bread: **PASS** Postscript name "EncodeSansCond-Black" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Encode Sans Condensed' in 'Encode Sans Condensed Black')
