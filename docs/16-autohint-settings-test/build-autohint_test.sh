...
hintedFile=$hintedDir/${fontFile/"VF"/"VF-stem_nnn-xht_18-max_18"}
echo $hintedFile
ttfautohint-vf -I $vf $hintedFile --stem-width-mode nnn --increase-x-height 18 --hinting-range-max=18
