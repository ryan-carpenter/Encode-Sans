...
* :fire: **FAIL** MS-FonVal: The device table StartSize is greater than the end size DETAILS: 
	- LookupList, Lookup[0], SubTable[0](PairPos, fmt 1), PairSet[9], PairValueRecord[0], Value1, XAdvDeviceTable
	- LookupList, Lookup[0], SubTable[0](PairPos, fmt 1), PairSet[9], PairValueRecord[1], Value1, XAdvDeviceTable
	- LookupList, Lookup[0], SubTable[0](PairPos, fmt 1), PairSet[9], PairValueRecord[2], Value1, XAdvDeviceTable
	- LookupList, Lookup[0], SubTable[0](PairPos, fmt 1), PairSet[9], PairValueRecord[3], Value1, XAdvDeviceTable
	- LookupList, Lookup[0], SubTable[0](PairPos, fmt 1), PairSet[9], PairValueRecord[4], Value1, XAdvDeviceTable
	- LookupList, Lookup[0], SubTable[0](PairPos, fmt 1), PairSet[9], PairValueRecord[5], Value1, XAdvDeviceTable
	- LookupList, Lookup[0], SubTable[0](PairPos, fmt 1), PairSet[9], PairValueRecord[6], Value1, XAdvDeviceTable
	- LookupList, Lookup[0], SubTable[0](PairPos, fmt 1), PairSet[9], PairValueRecord[7], Value1, XAdvDeviceTable
	- LookupList, Lookup[0], SubTable[0](PairPos, fmt 1), PairSet[9], PairValueRecord[8], Value1, XAdvDeviceTable
	- LookupList, Lookup[0], SubTable[0](PairPos, fmt 1), PairSet[9], PairValueRecord[9], Value1, XAdvDeviceTable
	- NOTE: 1121 other similar results were hidden!
* :fire: **FAIL** MS-FonVal: The AnchorFormat field is invalid DETAILS: 
	- LookupList, Lookup[1], SubTable[0](MarkBasePos), BaseArray, BaseRecord[0], BaseAnchor[1], AnchorFormat = 675
	- LookupList, Lookup[1], SubTable[0](MarkBasePos), BaseArray, BaseRecord[0], BaseAnchor[2], AnchorFormat = 675
	- LookupList, Lookup[1], SubTable[0](MarkBasePos), BaseArray, BaseRecord[0], BaseAnchor[5], AnchorFormat = 675
	- LookupList, Lookup[1], SubTable[0](MarkBasePos), BaseArray, BaseRecord[0], BaseAnchor[6], AnchorFormat = 675
	- LookupList, Lookup[1], SubTable[0](MarkBasePos), BaseArray, BaseRecord[1], BaseAnchor[1], AnchorFormat = 675
	- LookupList, Lookup[1], SubTable[0](MarkBasePos), BaseArray, BaseRecord[1], BaseAnchor[2], AnchorFormat = 675
	- LookupList, Lookup[1], SubTable[0](MarkBasePos), BaseArray, BaseRecord[1], BaseAnchor[5], AnchorFormat = 675
	- LookupList, Lookup[1], SubTable[0](MarkBasePos), BaseArray, BaseRecord[1], BaseAnchor[6], AnchorFormat = 675
	- LookupList, Lookup[1], SubTable[0](MarkBasePos), BaseArray, BaseRecord[2], BaseAnchor[1], AnchorFormat = 675
	- LookupList, Lookup[1], SubTable[0](MarkBasePos), BaseArray, BaseRecord[2], BaseAnchor[2], AnchorFormat = 675
	- NOTE: 2714 other similar results were hidden!
...
dist/EncodeSans-VF-2018-11-01-15_57/EncodeSans-VF.ttf (file 1 of 1)
Complete: dist/EncodeSans-VF-2018-11-01-15_57/EncodeSans-VF.ttf.report.xml
Reports are ready!
...
* :information_source: **INFO** MS-FonVal: Unable to perform test due to previously detected errors DETAILS: 
	...
	- Glyph index 28 Test: ValidateSimpContMisor 
	- Glyph index 46 Test: ValidateSimpContMisor 
	- Glyph index 69 Test: ValidateSimpContMisor 
	- Glyph index 70 Test: ValidateSimpContMisor 
	- Glyph index 100 Test: ValidateSimpContMisor 
	- Glyph index 112 Test: ValidateSimpContMisor 
	- Glyph index 114 Test: ValidateSimpContMisor 
	- Glyph index 121 Test: ValidateSimpContMisor 
	- NOTE: 252 other similar results were hidden!
...
* :information_source: **INFO** MS-FonVal: The post name isn't in uniXXXX or uXXXXX format and there is no Adobe Glyph List entry DETAILS: 
	- glyph = 1217, char = U+000D, name = CR
	- glyph = 1218, char = U+0000, name = NULL
* :information_source: **INFO** MS-FonVal: Rasterization not selected for validation
* :information_source: **INFO** MS-FonVal: Total time validating file DETAILS: 0:00:20
* :bread: **PASS** MS-FonVal: The numTables field is non-zero DETAILS: 19
...
* :bread: **PASS** MS-FonVal: The LangSysTable is valid DETAILS: 
	- ScriptList, ScriptRecord[0](DFLT), ScriptTable, DefaultLangSysTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable, DefaultLangSysTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable, LangSysRecord[0], LangSysTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable, LangSysRecord[1], LangSysTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable, LangSysRecord[2], LangSysTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable, LangSysRecord[3], LangSysTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable, LangSysRecord[4], LangSysTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable, LangSysRecord[5], LangSysTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable, LangSysRecord[6], LangSysTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable, LangSysRecord[7], LangSysTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable, LangSysRecord[8], LangSysTable
* :bread: **PASS** MS-FonVal: The Script Table is valid DETAILS: 
	- ScriptList, ScriptRecord[0](DFLT), ScriptTable
	- ScriptList, ScriptRecord[1](latn), ScriptTable
...
* :bread: **PASS** MS-FonVal: The Feature table is valid DETAILS: 
	...
	- FeatureList, FeatureRecord[2](mkmk), FeatureTable
	- FeatureList, FeatureRecord[0](aalt), FeatureTable
	- FeatureList, FeatureRecord[1](c2sc), FeatureTable
	- FeatureList, FeatureRecord[2](case), FeatureTable
	- FeatureList, FeatureRecord[3](ccmp), FeatureTable
	- FeatureList, FeatureRecord[4](ccmp), FeatureTable
	- FeatureList, FeatureRecord[5](dlig), FeatureTable
	- FeatureList, FeatureRecord[6](dnom), FeatureTable
...
* :bread: **PASS** MS-FonVal: The PairSet table is valid DETAILS: 
	...
	- NOTE: 100 other similar results were hidden!
...
* :bread: **PASS** MS-FonVal: The LigatureArray table is valid DETAILS: LookupList, Lookup[2], SubTable[0](MarkLigPos), LigatureArray
* :bread: **PASS** MS-FonVal: The MarkLigPos subtable is valid DETAILS: LookupList, Lookup[2], SubTable[0](MarkLigPos)
* :bread: **PASS** MS-FonVal: The Mark2Record is valid DETAILS: 
	- LookupList, Lookup[3], SubTable[0](MarkMarkPos), Mark2Array, Mark2Record[0]
	- LookupList, Lookup[3], SubTable[0](MarkMarkPos), Mark2Array, Mark2Record[1]
	- LookupList, Lookup[3], SubTable[0](MarkMarkPos), Mark2Array, Mark2Record[2]
	- LookupList, Lookup[3], SubTable[0](MarkMarkPos), Mark2Array, Mark2Record[3]
	- LookupList, Lookup[3], SubTable[0](MarkMarkPos), Mark2Array, Mark2Record[4]
	- LookupList, Lookup[3], SubTable[0](MarkMarkPos), Mark2Array, Mark2Record[5]
	- LookupList, Lookup[3], SubTable[0](MarkMarkPos), Mark2Array, Mark2Record[6]
	- LookupList, Lookup[3], SubTable[0](MarkMarkPos), Mark2Array, Mark2Record[7]
	- LookupList, Lookup[4], SubTable[0](MarkMarkPos), Mark2Array, Mark2Record[0]
	- LookupList, Lookup[4], SubTable[0](MarkMarkPos), Mark2Array, Mark2Record[1]
	- NOTE: 29 other similar results were hidden!
* :bread: **PASS** MS-FonVal: The Mark2Array table is valid DETAILS: 
	- LookupList, Lookup[3], SubTable[0](MarkMarkPos), Mark2Array
	- LookupList, Lookup[4], SubTable[0](MarkMarkPos), Mark2Array
	- LookupList, Lookup[5], SubTable[0](MarkMarkPos), Mark2Array
* :bread: **PASS** MS-FonVal: The MarkMarkPos subtable is valid DETAILS: 
	- LookupList, Lookup[3], SubTable[0](MarkMarkPos)
	- LookupList, Lookup[4], SubTable[0](MarkMarkPos)
	- LookupList, Lookup[5], SubTable[0](MarkMarkPos)
...
* :bread: **PASS** MS-FonVal: The SingleSubst subtable is valid DETAILS: 
	...
	- LookupList, Lookup[11], SubTable[0](SingleSubst, fmt 1)
	- LookupList, Lookup[12], SubTable[0](SingleSubst, fmt 1)
	- LookupList, Lookup[13], SubTable[0](SingleSubst, fmt 1)
	- LookupList, Lookup[14], SubTable[0](SingleSubst, fmt 1)
	- NOTE: 18 other similar results were hidden!
* :bread: **PASS** MS-FonVal: The AlternateSubst subtable is valid DETAILS: LookupList, Lookup[1], SubTable[0](AlternateSubst, fmt 1)
* :bread: **PASS** MS-FonVal: The LigatureSubst subtable is valid DETAILS: 
	- LookupList, Lookup[2], SubTable[0](LigatureSubst, fmt 1)
	- LookupList, Lookup[4], SubTable[0](LigatureSubst, fmt 1)
	- LookupList, Lookup[5], SubTable[0](LigatureSubst, fmt 1)
	- LookupList, Lookup[24], SubTable[0](LigatureSubst, fmt 1)
	- LookupList, Lookup[31], SubTable[0](LigatureSubst, fmt 1)
	- LookupList, Lookup[32], SubTable[0](LigatureSubst, fmt 1)
	- LookupList, Lookup[39], SubTable[0](LigatureSubst, fmt 1)
	- LookupList, Lookup[40], SubTable[0](LigatureSubst, fmt 1)
	- LookupList, Lookup[41], SubTable[0](LigatureSubst, fmt 1)
	- LookupList, Lookup[42], SubTable[0](LigatureSubst, fmt 1)
* :bread: **PASS** MS-FonVal: The ChainContextSubst subtable is valid DETAILS: 
	- LookupList, Lookup[3], SubTable[0](ChainContextSubst, fmt 3)
	- LookupList, Lookup[3], SubTable[1](ChainContextSubst, fmt 3)
	- LookupList, Lookup[19], SubTable[0](ChainContextSubst, fmt 3)
	- LookupList, Lookup[19], SubTable[1](ChainContextSubst, fmt 3)
	- LookupList, Lookup[22], SubTable[0](ChainContextSubst, fmt 3)
	- LookupList, Lookup[22], SubTable[1](ChainContextSubst, fmt 3)
	- LookupList, Lookup[33], SubTable[0](ChainContextSubst, fmt 3)
	- LookupList, Lookup[33], SubTable[1](ChainContextSubst, fmt 3)
	- LookupList, Lookup[33], SubTable[2](ChainContextSubst, fmt 3)
	- LookupList, Lookup[33], SubTable[3](ChainContextSubst, fmt 3)
	- LookupList, Lookup[36], SubTable[0](ChainContextSubst, fmt 3)
	- LookupList, Lookup[36], SubTable[1](ChainContextSubst, fmt 3)
...
* :bread: **PASS** MS-FonVal: The usFirstCharIndex and usLastCharIndex fields are valid DETAILS: first = 0x0000, last = 0xfb02
* :bread: **PASS** MS-FonVal: The CodePage Range fields' bits are all allowable values
* :bread: **PASS** MS-FonVal: The sxHeight field is nonzero DETAILS: 1080
* :bread: **PASS** MS-FonVal: The sCapHeight field is nonzero DETAILS: 1480
...
* :bread: **PASS** MS-FonVal: Font checksum is correct DETAILS: 0x0024c61f
...
* :bread: **PASS** MS-FonVal: The created time is not zero DETAILS: created = 3565332862 (Friday, December 23, 2016 10:14 AM)
* :bread: **PASS** MS-FonVal: The xMin value matches the minimum glyph xMin DETAILS: xMin = -300
* :bread: **PASS** MS-FonVal: The yMin value matches the minimum glyph yMin DETAILS: yMin = -460
* :bread: **PASS** MS-FonVal: The xMax value matches the maximum glyph xMax DETAILS: xMax = 2122
* :bread: **PASS** MS-FonVal: The yMax value matches the maximum glyph yMax DETAILS: yMax = 2120
...
* :bread: **PASS** MS-FonVal: The numGlyphs value equals the number of entries in the loca array plus one DETAILS: numGlyphs = 1219
...
* :bread: **PASS** MS-FonVal: The version string is in the correct format DETAILS: platID = 3, encID = 1, langID = 1033, "Version 2.000"
...
* :warning: **WARN** MS-FonVal: The value of sTypoAscender minus sTypoDescender is greater than unitsPerEm DETAILS: sTypoAscender = 2060, sTypoDescender = -440
...
* :warning: **WARN** MS-FonVal: The unitsPerEm value is not a power of two DETAILS: 2000
* :warning: **WARN** MS-FonVal: The modified time is an unlikely value DETAILS: modified = 3623947047 (Thursday, November 1, 2018 7:57 PM)
* :warning: **WARN** MS-FonVal: The lowestRecPPEM value may be unreasonably small DETAILS: lowestRecPPEM = 6
* :warning: **WARN** MS-FonVal: Ascender is different than OS/2.usWinAscent. Different line heights on Windows and Apple DETAILS: hhea.Ascender = 2060, OS/2.usWinAscent = 2758
* :warning: **WARN** MS-FonVal: Descender is different than OS/2.usWinDescent. Different line heights on Windows and Apple DETAILS: hhea.Descender = -440, OS/2.usWinDescent = 520
* :warning: **WARN** MS-FonVal: The LineGap value is less than the recommended value DETAILS: LineGap = 0, recommended = 778
* :warning: **WARN** MS-FonVal: The leftSideBearing is greater than the advance width (unlikely value) DETAILS: {'Glyph index': [1048, 1049, 1051, 1053, 1054, 1055, 1056, 1057, 1058, 1059, 1061, 1062, 1063, 1064, 1065, 1066, 1067, 1068, 1070, 1071, 1072, 1073, 1074, 1075, 1076, 1077, 1078, 1079, 1080, 1081, 1082, 1083, 1084, 1085, 1086, 1088, 1090, 1091, 1092, 1093, 1094, 1095, 1096, 1098, 1099, 1100, 1101, 1102, 1103, 1104, 1105, 1107, 1108, 1109, 1110, 1111, 1112, 1113, 1114, 1115, 1116, 1117, 1118, 1119, 1120, 1121, 1122, 1123, 1124, 1125, 1127, 1129, 1153, 1154, 1156, 1158, 1159, 1160, 1161, 1162, 1163, 1164, 1166, 1167, 1168, 1169, 1170, 1171, 1172, 1174, 1175, 1176, 1177, 1178, 1179, 1180, 1181, 1182, 1183, 1184, 1185, 1186, 1187, 1189, 1190, 1191, 1192, 1193, 1194, 1195, 1196, 1197, 1198, 1199, 1200, 1201, 1202, 1203, 1204, 1205, 1206, 1207, 1208, 1209, 1210, 1211, 1212, 1213]}
* :warning: **WARN** MS-FonVal: Loca references a glyf entry which length is not a multiple of 4 DETAILS: Number of glyphs with the warning = 455
...
|  | dist/EncodeSans-VF-2018-11-01-15_57/EncodeSans-VF.ttf |
|:--- | ---:|
| Dehinted Size | 282.2kb |
| Hinted Size | 281.0kb |
| Increase | -1284 bytes |
| Change   | -0.0 % |
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, GPOS, loca]
...
* :bread: **PASS** dist/EncodeSans-VF-2018-11-01-15_57/EncodeSans-VF.ttf is named canonically.
