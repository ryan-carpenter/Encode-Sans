...
* :fire: **FAIL** head version is ('2', '000'), name version string for platform 1, encoding 0, is ('1', '000') [code: mismatch]
* :fire: **FAIL** head version is ('2', '000'), name version string for platform 3, encoding 1, is ('1', '000') [code: mismatch]
...
* :fire: **FAIL** The 'wght' axis coordinate of the 'Regular' instance must be 400. Got a '381.81818' coordinate instead.
...
* :fire: **FAIL** The 'wdth' coordinate of the 'Regular' instance must be 100. Got 500.0 as a default value instead.
...
* :fire: **FAIL** The 'wght' axis coordinate of the 'Bold' instance must be 700. Got a '566.66667' coordinate instead.
...
* :warning: **WARN** Name table entry ("Copyright (c) 2014, Impallari Type (www.impallari.com), with Reserved Font Name Encode Sans.") contains "Reserved Font Name". This is an error except in a few specific rare cases.
...
|  | dist/EncodeSans-VF-2018-10-11-18_55/EncodeSans-VF.ttf |
|:--- | ---:|
| Dehinted Size | 297.4kb |
| Hinted Size | 296.3kb |
| Increase | -1080 bytes |
| Change   | -0.0 % |
...
* :information_source: **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 1.000', 'Version 1.000']
...
* :information_source: **INFO** Version string is: "Version 1.000"
...
* :bread: **PASS** dist/EncodeSans-VF-2018-10-11-18_55/EncodeSans-VF.ttf is named canonically.
